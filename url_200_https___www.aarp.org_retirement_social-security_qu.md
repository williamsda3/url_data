Title: How to Fix a Social Security Benefit Payment Error

URL Source: https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount/
...
[Skip to content](https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount/#)

[](https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount/#)[](https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount/#)
...
[Back](https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount/#) [Cancel](https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount/#)
...
[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/monto-de-mi-beneficio-no-es-correcto/)

Published July 09, 2020

/ Updated March 25, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount.html&related=CreateTheGood&text=What%20if%20my%20Social%20Security%20benefit%20is%20the%20wrong%20amount?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount.html&title=What%20if%20my%20Social%20Security%20benefit%20is%20the%20wrong%20amount?)
...
The SSA pays out more than $1 trillion a year in retirement benefits, survivor benefits and [Social Security Disability Insurance](https://www.aarp.org/retirement/social-security/questions-answers/apply-for-ss-disability/ "how to apply for social security disability insurance") (SSDI). In the 2022 federal fiscal year, that included an estimated $13.6 billion in “improper payments,” according to a [November 2023 report](https://oig.ssa.gov/assets/uploads/022330.pdf "social security inspector general report") from the SSA’s Office of the Inspector General: $11.1 billion in overpayments and $2.5 billion in underpayments.

Members only

                     

If you believe you were either overpaid or underpaid by Social Security, [tell the SSA](https://www.ssa.gov/agency/contact/) as soon as possible. Failing to report the error in a timely way can lead to months of incorrect payments along with the eventual hassle of sorting it out.
...
*   Your case might not be finished. If a beneficiary [appeals](https://www.aarp.org/retirement/social-security/questions-answers/how-to-appeal-disability-benefits-decision/) a loss or reduction of benefits, the SSA is required in some instances to keep paying the amount in question until the case is decided. If the appeal fails, then the beneficiary was getting the “wrong” amount during this time.

Mistakes are most prevalent in SSDI and, especially, [Supplemental Security Income](https://www.aarp.org/retirement/social-security/questions-answers/what-is-ssi/) (SSI), the other SSA-administered benefit that serves [people with disabilities](https://www.aarp.org/work/social-security/question-and-answer/disability-benefits/).

Eligibility for these programs is subject to [strict limits on work activity](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/) and, in the case of SSI, ceilings on [income](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/) and [financial resources](https://www.aarp.org/retirement/social-security/questions-answers/how-do-financial-resources-impact-ssi-eligibility/). Unreported or unidentified income and assets are leading causes of payment errors, according to Social Security.

In the 2023 fiscal year, SSI recipients were overpaid by an estimated $4.6 billion, accounting for 8 percent of total payments under the program, according to an [SSA report](https://www.cfo.gov/wp-content/uploads/scorecards/FY24-Q1/Supplemental%20Security%20Income%20(SSI).pdf "social security payment errors report") to the U.S. Office of Management and Budget.
...
Typically, the SSA withholds some of your corrected monthly benefit to put toward repayment. The agency used to cut off benefits entirely in some cases, but as of March 25, 2024, these “clawbacks” are capped at 10 percent, one of several changes the SSA announced that month to [ease the financial burden](https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount/ "social security overpayment changes") on beneficiaries facing overpayment bills.

If you no longer are receiving benefits, the agency seeks a lump sum refund, which you can repay online using the Treasury Department's [Pay.gov service](https://www.pay.gov/public/home). You'll find information on using Pay.gov on your billing notice.
...
The SSA has the authority to [garnish wages](https://www.aarp.org/retirement/social-security/questions-answers/social-security-garnished/) or income tax refunds if you don't comply. But it also can work with you to set up a monthly payment plan you can afford. In most cases the repayment period can be up to five years.

You can request an outright waiver of the debt by filing [Form SSA-632](http://www.ssa.gov/forms/ssa-632.html). You'll have to demonstrate that the overpayment was not your fault or that you cannot afford to repay it.

If you don't think you were overpaid, you can appeal using [Form SSA-561-U2](http://www.ssa.gov/forms/ssa-561.pdf). You have 60 days from the date you receive the overpayment notice to file your appeal.

You'll find more information in the Social Security publication [Overpayments](https://www.ssa.gov/pubs/EN-05-10098.pdf).

### **What to do if you've been underpaid**

If you get a benefit payment you believe was too little, call the SSA at 800-772-1213 or [visit a Social Security office](https://secure.ssa.gov/ICON/main.jsp). Social Security will investigate the matter and compensate you for any underpayment in a lump sum or through increased monthly payments. For office visits, Social Security recommends calling in advance and scheduling an appointment to avoid long waits.

The chief cause of underpayments is computational or clerical errors, often arising from inaccurate information in a beneficiary's earnings history. That's the year-by-year listing in Social Security's records of how much you made over your career and the foundation for [computing your benefit](https://www.aarp.org/retirement/social-security/questions-answers/social-security-benefits-calculation/).

You can check your earnings record online at any time if you have a [My Social Security account](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/). If you spot discrepancies or omissions, report them to Social Security to seek a correction.

You'll want to assemble proof of earnings such as W-2 forms, tax returns and pay stubs. For more details, see the SSA publication [How to Correct Your Social Security Earnings Record](http://www.socialsecurity.gov/pubs/EN-05-10081.pdf).

#### **Keep in mind**

The time limit for correcting an entry in your earnings record is three years, three months and 15 days after the tax year in question. After that, Social Security will not make revisions except in a [handful of circumstances](https://www.ssa.gov/OP_Home/handbook/handbook.14/handbook-1424.html), among them inaccuracies resulting from fraud, mechanical or clerical errors; wages omitted from an employer's tax filings; and earnings credited to the wrong person or time period.

[%{postComment}%](https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount/#comments_widget_id)

_Andy Markowitz covers Social Security and retirement for AARP. He is a former editor of the_  Prague Post _and_  Baltimore City Paper_._
...
More on Social Security
     ...
     [![Image 273: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 274: cartoon of a woman in a pool in a float sipping a drink](https://cdn.aarp.net/content/dam/aarpe/en/home/retirement/social-security/questions-answers/benefit-payment-wrong-amount/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/social-security-retirement-estimates1.coreimg.50.932.jpeg/content/dam/aarp/retirement/social-security/2021/12/1140-ssa-retirement-relax.jpg)](https://www.aarp.org/retirement/social-security/questions-answers/social-security-retirement-estimates/ "Do the retirement estimates on my Social Security statement include future earnings?")

[Do the retirement estimates on my Social Security statement include future earnings?](https://www.aarp.org/retirement/social-security/questions-answers/social-security-retirement-estimates/)

     [![Image 275: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 276: a happy older couple](https://cdn.aarp.net/content/dam/aarpe/en/home/retirement/social-security/questions-answers/benefit-payment-wrong-amount/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/social-security-garnished2.coreimg.50.932.jpeg/content/dam/aarp/retirement/social-security/2021/12/1140-ssa-retirement-selfie.jpg)](https://www.aarp.org/retirement/social-security/questions-answers/social-security-garnished/ "Can Social Security payments be garnished?")

[Can Social Security payments be garnished?](https://www.aarp.org/retirement/social-security/questions-answers/social-security-garnished/)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 277: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 278](https://www.aarp.org/retirement/social-security/questions-answers/benefit-payment-wrong-amount/)
