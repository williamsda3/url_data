Title: Will My SSDI Benefit Increase If My Condition Worsens?

URL Source: https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens/
...
[Skip to content](https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens/#)

[](https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens/#)[](https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens/#)
...
[Back](https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens/#) [Cancel](https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens/#)
...
[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/beneficio-por-discapacidad-aumenta-si-condicion-empeora/)

Published July 09, 2020

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens.html&related=CreateTheGood&text=Will%20my%20disability%20benefit%20go%20up%20if%20my%20disability%20gets%20worse?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens.html&title=Will%20my%20disability%20benefit%20go%20up%20if%20my%20disability%20gets%20worse?)

No, [Social Security Disability Insurance](https://www.aarp.org/retirement/social-security/questions-answers/apply-for-ss-disability/) (SSDI) payments do not change if your condition becomes more severe or limiting. Here’s why:

SSDI benefits are based on your earnings history, not the level of your disability. If your SSDI claim is approved, your disability benefit will be the same as a full retirement benefit — the amount you would have received based on your work record if you had been at [full retirement age](https://www.aarp.org/retirement/social-security/questions-answers/social-security-full-retirement-age/) when you became disabled.

Members only

                     

And in approving your claim, the Social Security Administration (SSA) already has determined you to be fully disabled by its definition: Your [illness or injury](https://www.aarp.org/retirement/social-security/questions-answers/medical-conditions/) prevents you from doing most work and is expected to last at least 12 months or end in death. Your condition may worsen, but you still are fully disabled.

On the other hand, if your condition improves, you might lose benefits.

Social Security periodically [reviews SSDI recipients’ medical status](https://www.aarp.org/retirement/social-security/questions-answers/what-is-a-social-security-disability-review/) to see if they still qualify as disabled. If the review shows that your health has improved to the point where you can work regularly, benefits will stop.

The same holds true for [Supplemental Security Income](https://www.aarp.org/retirement/social-security/questions-answers/what-is-ssi/) (SSI), the other Social Security-run program that pays benefits to people with disabilities.
...
*   Because eligibility for Supplemental Security Income rests on financial need, SSI recipients of any age are subject to periodic reviews of their assets, income and living arrangements, which can lead to those benefits ending.
*   A worsening medical situation can affect how Social Security handles an application for disability benefits. The SSA can [fast-track claims](https://www.aarp.org/retirement/social-security/questions-answers/ssa-disability-fast-track-decision/) from applicants with particular illnesses or disorders, and the severity of your condition can affect your chances for a quick decision.

[%{postComment}%](https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens/#comments_widget_id)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 261: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 262](https://www.aarp.org/retirement/social-security/questions-answers/will-disability-benefit-change-if-condition-worsens/)
