Title: Can You Suspend Social Security and Restart Benefits Later?

URL Source: https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart/
...
[Skip to content](https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart/#aarp-u-end-of-header)
...
[](https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart/#)[](https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart/#)
...
[Back](https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart/#) [Cancel](https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart/#)
...
[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/suspender-y-solicitar-beneficios-por-mas-valor/)

Published September 12, 2022

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart.html&related=CreateTheGood&text=Can%20I%20suspend%20Social%20Security%20benefits%20and%20restart%20them%20at%20a%20higher%20value?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart.html&title=Can%20I%20suspend%20Social%20Security%20benefits%20and%20restart%20them%20at%20a%20higher%20value?)

Yes. If you have reached your [full retirement age](https://www.aarp.org/retirement/social-security/questions-answers/social-security-full-retirement-age/) (the age at which you are entitled to 100 percent of the benefit calculated from your lifetime earnings) but are not yet 70, you can request a suspension of retirement benefits. Full retirement age is 66 and 4 months for people born in 1956 and is gradually rising to 67 for those born in 1960 and after.

Members only

                     

If you can afford to do without your retirement benefit for a few years, this might make long-term financial sense. During a suspension, you earn [delayed retirement credits](https://www.aarp.org/retirement/social-security/questions-answers/delayed-retirement-credits/), which boost your eventual benefit by two-thirds of 1 percent for each suspended month (or 8 percent for each suspended year). When you resume collecting Social Security, you’ll have locked in a higher monthly payment for life.

You can request a suspension [by phone](https://www.ssa.gov/agency/contact/phone.html), in writing or in person at your [local Social Security office](https://secure.ssa.gov/ICON/main.jsp). Local offices [fully reopened April 7](https://www.aarp.org/retirement/social-security/info-2021/field-offices-reopening-plan.html) after being closed to walk-in traffic for more than two years due to the [COVID-19 pandemic](https://www.aarp.org/health/conditions-treatments/info-2020/coronavirus-facts.html), but Social Security recommends calling in advance and scheduling an appointment to avoid long waits.

You can ask Social Security to resume payments at any time until you turn 70. If you haven’t done it by then, Social Security will automatically reinstate your benefits in the higher amount_._

If you have not yet reached full retirement age, the only option for stopping Social Security payments is to apply for a [“withdrawal of benefits,”](https://www.aarp.org/retirement/social-security/questions-answers/social-security-going-back-to-work/) a more formal process that, unlike a suspension, requires you to repay Social Security the benefits you have received to date.
...
*   You cannot [collect retroactive benefits](https://www.aarp.org/retirement/social-security/questions-answers/collecting-social-security-benefits-retroactively/) for the months in which your payments were suspended. Retroactivity is only available in connection with an initial claim for retirement benefits, if made after full retirement age.

[%{postComment}%](https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart/#comments_widget_id)
...
[Can couples still use the 'file and suspend' strategy?](https://www.aarp.org/retirement/social-security/questions-answers/ss-couples-file-and-suspend/)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 261: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 262](https://www.aarp.org/retirement/social-security/questions-answers/suspend-social-security-then-restart/)
