Title: Can You Get Both SSDI and SSI Disability Benefits?

URL Source: https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/
...
[Skip to content](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/#aarp-u-end-of-header)
...
[](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/#)[](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/#)
...
[Back](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/#) [Cancel](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/#)
...
[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/recibir-ssdi-y-ssi/)

Published June 08, 2021

/ Updated December 31, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi.html&related=CreateTheGood&text=Can%20I%20get%20both%20SSDI%20and%20SSI?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi.html&title=Can%20I%20get%20both%20SSDI%20and%20SSI?)

Yes, you can receive [Social Security Disability Insurance](https://www.aarp.org/retirement/social-security/questions-answers/apply-for-ss-disability/ "apply for disability") (SSDI) and [Supplemental Security Income](https://www.aarp.org/retirement/social-security/questions-answers/what-is-ssi/ "what is SSI") (SSI) at the same time. Social Security uses the term “concurrent” when you qualify for [both disability benefits](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works/ "how SSI and SSDI works") it administers.
...
Both SSDI and SSI provide benefits to people who meet Social Security's definition of a disability: [a physical or mental health condition](https://www.aarp.org/retirement/social-security/questions-answers/medical-conditions/ "medical conditions") severe enough to prevent you from doing most work for at least a year. But SSDI provides payments to people with disabilities regardless of their financial situation. Qualification is tied to [how long you were employed](https://www.aarp.org/retirement/social-security/questions-answers/how-long-do-i-have-to-work-to-qualify-for-ssdi/ "work requirements for SSDI") in work for which you paid [Social Security taxes](https://www.aarp.org/retirement/social-security/questions-answers/ss-fica/ "Social Security and FICA taxes"), and payment amounts are [based on your average lifetime earnings](https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation.html "SSDI benefit calculations").

SSI, on the other hand, is [needs-based](https://www.aarp.org/retirement/social-security/questions-answers/ssi-eligible/ "SSI eligibility"). It pays benefits to people who are 65 or older, blind or have a disability and have low incomes and [limited financial resources](https://www.aarp.org/retirement/social-security/questions-answers/how-do-financial-resources-impact-ssi-eligibility/ "financial resources and SSI"). It is unrelated to your employment history; you can receive SSI even if you never worked or paid Social Security taxes.

But you can't get SSI if what Social Security calls your [“countable” income](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/ "what counts as income for SSI") exceeds a federally set threshold, which in 2025 is $967 a month for individuals and $1,450 for couples when both spouses are eligible for the program. Those figures are also the maximum federal SSI payments.

Social Security considers SSDI and other benefit payments to be countable but exempts $20 a month from that tally. Thus, if you get a monthly SSDI benefit that exceeds $987 you don't qualify for SSI. If your SSDI payment is less than that, you may be able to get SSI, but it will be reduced by most of the amount of your SSDI.
...
For one thing, if you qualify for a low SSDI benefit because you had a low-wage job or worked for only a short time before becoming disabled, SSI can be an additional income source until you're able to [go back to work](https://www.aarp.org/retirement/social-security/questions-answers/what-is-ticket-to-work-program/ "ticket to work program").
...
For another, there's a [waiting period for SSDI](https://www.aarp.org/retirement/social-security/questions-answers/how-long-does-it-take-for-disability-benefits-to-start/ "when does disability benefits start"): Benefits start in the sixth month after the date on which Social Security determines you become disabled. There's no such gap with Supplemental Security Income, so you could draw a full SSI benefit while waiting for SSDI to kick in.

A concurrent claim can also help with health care. SSDI recipients are eligible for Medicare, but in most circumstances, that coverage doesn't begin until you've been getting benefits for 24 months. SSI recipients in most states automatically qualify for Medicaid, which could [help cover your health costs](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-medicaid/ "SSDI and Medicaid") while you wait for Medicare to start. Once it does, you may be able to stay on Medicaid, which covers some costs Medicare does not.

You can [apply for concurrent benefits online](https://www.ssa.gov/applyfordisability/ "apply for disability"), by phone (start by calling 800-772-1213) or in person ([Social Security offices](https://www.aarp.org/retirement/social-security/info-2021/field-offices-reopening-plan.html "Social Security offices reopen") are open, even for unscheduled visits, but making an appointment is recommended). Social Security provides an [adult disability checklist](https://www.ssa.gov/hlp/radr/10/ovw001-checklist.pdf "adult disability checklist") to assist you in gathering the materials you need. [For some applicants](https://www.aarp.org/retirement/social-security/questions-answers/can-i-apply-for-supplemental-security-income-online/ "apply for SSI online"), the SSI process will require a direct interview with a Social Security representative, which can be done by phone.

#### Keep in mind

Along with SSDI benefits, income from work and other sources can be used to determine SSI eligibility and payments. The rules for what counts and what doesn't are complicated. Social Security's SSI website has a [detailed page on the income rules](https://www.ssa.gov/ssi/text-income-ussi.htm "SSI income rules").

[%{postComment}%](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/#comments_widget_id)

_Edward C. Baig covers technology and other consumer topics. He previously worked for_ USA Today_,_ BusinessWeek_,_ U.S. News & World Report _and_ Fortune_, and is author of_ Macs for Dummies _and coauthor of_ iPhone for Dummies _and_ iPad for Dummies_. Follow him on [LinkedIn](https://www.linkedin.com/in/edward-baig-1699b/ "ed baig on linkedin"); [Threads](https://www.threads.net/@edbaig "ed baig on threads"); and [X, formerly known as Twitter](https://twitter.com/edbaig "ed baig on twitter")._
...
[Who is eligible for SSI?](https://www.aarp.org/retirement/social-security/questions-answers/ssi-eligible/)

[Do I need an attorney to apply for Social Security disability benefits?](https://www.aarp.org/retirement/social-security/questions-answers/social-security-disability-application-attorney/)

[What is Social Security disability back pay?](https://www.aarp.org/retirement/social-security/questions-answers/disability-back-pay/)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 269: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 270](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/)
