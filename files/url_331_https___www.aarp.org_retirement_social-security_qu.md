Title: Savings Accounts and Social Security Disability Benefits

URL Source: https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi/

Markdown Content:
Savings Accounts and Social Security Disability Benefits
===============
                                                     

[Skip to content](https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi/#)

[](https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi/#)[](https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi/#)
...
[Back](https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi/#) [Cancel](https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi/#)
...
[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/cuenta-de-ahorros-si-tengo-ssdi-o-ssi/)

Published August 18, 2021

/ Updated January 19, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi.html&related=CreateTheGood&text=Can%20I%20have%20a%20savings%20account%20while%20on%20Social%20Security%20disability?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi.html&title=Can%20I%20have%20a%20savings%20account%20while%20on%20Social%20Security%20disability?)

Yes. If you receive [Social Security Disability Insurance](https://www.aarp.org/retirement/social-security/questions-answers/apply-for-ss-disability/ "Social Security Disability Insurance") (SSDI) or [Supplemental Security Income](https://www.aarp.org/retirement/social-security/questions-answers/what-is-ssi/ "Supplemental Security Income") (SSI) you can have a savings account. However, there could be limits on how much you can have in it, depending on which type of disability benefit you collect.

To be eligible for SSDI, you must have a [work history](https://www.aarp.org/retirement/social-security/questions-answers/how-long-do-i-have-to-work-to-qualify-for-ssdi/ "qualifying work history") and a [medical condition](https://www.aarp.org/retirement/social-security/questions-answers/medical-conditions/ "qualifying medical condition") that leaves you unable to work for at least a year or is expected to end in death. There are limits on [how much you can earn from work](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/ "earned income") while collecting SSDI payments but no restrictions on assets. You can have a savings account with as much money in it as you choose to save.

Members only

                     

That is not the case if you receive SSI, which provides cash assistance to people who are 65 or older, blind or have a disability and are in financial need. The Social Security Administration (SSA), which operates the program, sets different (and [considerably more complex](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/)) limits on income for SSI recipients, and also sets a ceiling on financial assets: You can't own more than $2,000 in what the SSA considers [“countable resources”](https://www.aarp.org/retirement/social-security/questions-answers/how-do-financial-resources-impact-ssi-eligibility/ "financial asset limits for supplemental security income eligibility") as an individual or more than $3,000 as a couple.
...
The SSA makes exceptions for certain savings vehicles and programs designed for people with disabilities and/or low incomes. Using them, some beneficiaries can have well over $2,000 in savings and keep collecting SSI.
...
[ABLE accounts](https://www.aarp.org/money/investing/info-2023/how-able-accounts-help-people-with-disabilities.html "able savings accounts for people with disabilities") provide a tax-free savings opportunity for people with disabilities that were diagnosed before they reached age 26. (Federal legislation passed in 2022 will increase the threshold age to 46, starting in 2026.) The first $100,000 in an ABLE account is not a countable resource for SSI. Any balance over $100,000 will be figured into calculating whether you meet the cap on assets.
...
You can open an account through ABLE programs available in 46 states (all but Idaho, North Dakota, South Dakota and Wisconsin) and the District of Columbia. Many allow eligible out-of-state residents to set up accounts, but there may be tax advantages to using your own state's plan. The ABLE National Resource Center lets you [compare state programs](http://www.ablenrc.org/compare-states/ "ABLE state comparison").

#### **Plan to Achieve Self-Support (PASS)**

This is a written plan you submit to Social Security outlining a work-related goal that can help you become financially self-sufficient and reduce or eliminate your need for disability benefits. With a [PASS](https://www.ssa.gov/ssi/spotlights/spot-plans-self-support.htm "Social Security PASS program"), you can set aside money for items needed to reach that goal, such as education, childcare or assistive technology. That money is not considered a countable resource for SSI.

To apply for a PASS, fill out [form SSA-545-BK](https://www.ssa.gov/forms/ssa-545.pdf "SSA-545 form") and send it to your [local Social Security office](https://secure.ssa.gov/ICON/main.jsp "Social Security locations"). The SSA can refer you to a vocational counselor or [PASS specialist](https://www.ssa.gov/disabilityresearch/wi/passcadre.htm "PASS specialist") in your region for help writing your plan. Call the SSA at 800-772-1213 or consult its [PASS brochure](https://www.ssa.gov/pubs/EN-05-11017.pdf "PASS brochure") to learn more.

#### **Individual Development Accounts (IDAs)**

[IDAs](https://www.ssa.gov/ssi/spotlights/spot-individual-development.htm "Social Security IDA program") serve as vehicles for people with low incomes to save money from their earnings for education, buying a first home or costs associated with starting a business.

To open an IDA, in most cases you must be working and receiving [Temporary Assistance for Needy Families](https://www.hhs.gov/answers/programs-for-families-and-children/what-is-tanf/index.html "temporary assistance programs") (TANF) benefits. Your contributions to the account can be matched by funds from state and federal aid programs, and none of that money is counted when determining your eligibility for SSI. Contact your [state TANF agency](https://www.acf.hhs.gov/ofa/map/about/help-families "TANF locations") for information.
...
Whether that's the case will depend on the type of trust, who controls it and how its contents are used. For example, money paid directly to you from a trust, or used to provide your food and shelter, can be counted as income and deducted from your SSI benefit. You can learn more in the SSA online article [Spotlight on Trusts.](https://www.ssa.gov/ssi/spotlights/spot-trusts.htm "Social Security article about trusts")
...
*   If you live with a spouse or parent, or are an [immigrant](https://www.aarp.org/retirement/social-security/questions-answers/ssi-for-non-citizen/) with a sponsor, a portion of their assets, including money in the bank, may be counted toward your SSI eligibility.

[%{postComment}%](https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi/#comments_widget_id)

[More Social Security FAQs](https://www.aarp.org/retirement/social-security/questions-answers/disability-benefits/)
...
[What counts as income for SSI?](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/)

[Working Part-Time While on Social Security Disability Benefits](https://www.aarp.org/retirement/social-security/questions-answers/part-time-work-on-disability/)

[I receive Social Security disability benefits. Can I withdraw funds from my 401(k) or IRA without penalty?](https://www.aarp.org/retirement/social-security/questions-answers/disability-benefits-401k-withdrawal/)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 269: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 270](https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi/)
