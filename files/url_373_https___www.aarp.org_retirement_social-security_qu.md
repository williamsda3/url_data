Title: Social Security SSDI and SSI are Different Programs

URL Source: https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works/
...
[Skip to content](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works/#)

[](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works/#)[](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works/#)
...
[Back](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works/#) [Cancel](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works/#)
...
[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/diferencia-entre-ssdi-y-ssi/)

Published October 26, 2020

/ Updated December 15, 2023

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works.html&related=CreateTheGood&text=What%27s%20the%20difference%20between%20SSDI%20and%20SSI?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works.html&title=What%27s%20the%20difference%20between%20SSDI%20and%20SSI?)

[Social Security Disability Insurance](https://www.aarp.org/retirement/social-security/questions-answers/apply-for-ss-disability/ "Social Security disability") (SSDI) and [Supplemental Security Income](https://www.aarp.org/retirement/social-security/questions-answers/what-is-ssi/ "SSI") (SSI) both pay benefits to people that the Social Security Administration [deems disabled](https://www.aarp.org/retirement/social-security/questions-answers/medical-conditions/ "medical conditions").
...
*   **SSDI** is available to people with physical and mental impairments severe enough to prevent them from engaging in their normal occupations or any other [substantial work](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/ "substantial gainful activity"). The disability must be expected to last for at least 12 months or to end in death.
*   **SSI** is a safety net program that pays benefits to people who are disabled, usually based on the same definition used for SSDI; blind; or 65 and older. They must have very limited [income](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/ "SSI income requirements") and [assets](https://www.aarp.org/retirement/social-security/questions-answers/how-do-financial-resources-impact-ssi-eligibility/ "assets and SSI eligibility").

### **How to qualify**

*   **SSDI** is an earned benefit. As with Social Security retirement benefits, you [qualify by working](https://www.aarp.org/retirement/social-security/questions-answers/how-long-do-i-have-to-work-to-qualify-for-ssdi/ "qualify for SSDI") and [paying Social Security taxes](https://www.aarp.org/retirement/social-security/questions-answers/ss-tax-rate/ "Social Security tax rates"). How long you must have worked to be eligible varies based on your age when you become disabled.

As it does for the spouses and children of retirees, Social Security can pay additional benefits to the [spouses](https://www.aarp.org/retirement/social-security/questions-answers/receiving-disability-is-wife-eligible-spouse-benefits/ "spousal benefits") and [children](https://www.aarp.org/retirement/social-security/questions-answers/benefits-for-children/ "benefits for children") of disabled workers. Adults who have been disabled since childhood may qualify for SSDI on a parent's record even if they never have worked.
...
In 2024, the maximum federal SSI payment is $943 a month for an individual and $1,415 a month for a couple receiving SSI jointly. Income up to those levels can result in your benefit being reduced; income above them can render you ineligible for the program.
...
Both workers and their employers primarily bear the cost of the program through payroll taxes. Benefits are paid out of Social Security's [Disability Insurance Trust Fund](https://www.aarp.org/retirement/social-security/questions-answers/how-is-social-security-funded/ "how is Social Security funded").

Payment amounts are based on your earnings history. In November 2023, the average monthly SSDI benefit was about $1,489.
...
The Social Security Administration generally uses the same [medical criteria](https://www.aarp.org/retirement/social-security/questions-answers/blue-book/ "blue book") and the same process to determine if a disability entitles an adult to SSDI or SSI. [Collecting both benefits](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/ "SSDI and SSI") is permitted.

The condition must be expected to last at least a year or result in death and must prevent you for doing most work.

Social Security requires considerable medical evidence to back up a disability claim for either benefit. Although you can [apply online](https://www.ssa.gov/applyfordisability/ "apply for disability") for SSDI, and in [some cases for SSI](https://www.aarp.org/retirement/social-security/questions-answers/can-i-apply-for-supplemental-security-income-online/ "supplemental security income"), the process will include an in-person or phone interview with a Social Security representative.

Getting a decision generally takes three to five months, according to Social Security officials, but the time can vary depending on how long Social Security needs to get medical records and other relevant evidence. Military veterans and people with [particular severe medical issues](https://www.aarp.org/retirement/social-security/questions-answers/ssa-disability-fast-track-decision/ "SSA disability fast track decisions") may qualify for expedited processing.

#### **Keep in mind**

A majority of applications for disability benefits are initially denied. If your application is rejected, you have the [right to appeal](https://www.aarp.org/retirement/social-security/questions-answers/appeal-a-decision-by-the-ssa/ "appeal an SSA decision"), but getting a hearing can take a year or more. The Social Security Administration has a considerable backlog of cases.

[%{postComment}%](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works/#comments_widget_id)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 269: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 270](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-ssi-how-each-works/)
