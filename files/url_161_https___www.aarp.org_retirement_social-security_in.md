Title: How are Social Security disability benefits calculated?

URL Source: https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation/

Published Time: 2021-09-21T04:00:00+0000
...
[Skip to content](https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation/#)

[](https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation/#)[](https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation/#)
...
[Back](https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation/#) [Cancel](https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation/#)
...
[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/calcular-beneficios-de-incapacidad-ssdi/)

Published September 21, 2021

/ Updated December 30, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation.html&related=CreateTheGood&text=How%20are%20Social%20Security%20disability%20benefits%20calculated?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation.html&title=How%20are%20Social%20Security%20disability%20benefits%20calculated?)

Mathematically speaking, [Social Security Disability Insurance](https://www.aarp.org/retirement/social-security/questions-answers/apply-for-ss-disability/ "SSDI") (SSDI) is calculated in the same way as Social Security retirement benefits. Both are based on your record of “covered earnings” — work income on which you [paid Social Security taxes](https://www.aarp.org/retirement/social-security/questions-answers/ss-tax-rate/ "earnings counted for Social Security").
...
The [PIA formula](https://www.aarp.org/retirement/social-security/questions-answers/social-security-benefits-calculation/ "PIA") is progressive — weighted to provide proportionally higher benefits to lower earners — and it’s the same whether you’re claiming retirement or disability benefits. What differs is how much income data goes into determining your full benefit and when you can collect it.

For retirees, the SSA uses the 35 highest-earning years to calculate the monthly average income and PIA. (Only yearly earnings up to an [annually adjusted cap](https://www.aarp.org/retirement/social-security/questions-answers/maximum-amount-income-subject-to-fica-tax/ "annually adjusted cap") are counted. In 2025, the cap is $176,100.) You become eligible to claim that full amount at [full retirement age](https://www.aarp.org/retirement/social-security/questions-answers/social-security-full-retirement-age/ "full retirement age"), which is 66 and 8 months for those born in 1958, 66 and 10 months for those born in 1959 and 67 for those born in 1960 or later. Benefits are [reduced if you claim earlier](https://www.aarp.org/retirement/social-security/questions-answers/how-much-does-early-retirement-reduce-benefits/ "early retirement benefit impact") — by as much as 30 percent if you start taking them at the minimum age of 62.

Because a worker may become unable to work due to an injury or illness before reaching retirement age, Social Security uses a different time frame to determine the primary insurance amount for SSDI claims. The number of years of income used to figure the benefit depends on the age your disability began.
...
Suppose you’ve been working without interruption since age 21 but are sidelined at 60 by advanced [rheumatoid arthritis](https://www.aarp.org/health/conditions-treatments/info-2020/arthritis-symptoms.html "rheumatoid arthritis"). Applying its computation rules, Social Security would use your 33 best years of income, indexed for wage trends, to figure your PIA. If your disability struck at 50, it would be your 23 highest-earning years; at 40, the top 15 years.
...
Still, that full payment tends to be lower for SSDI recipients than for retirees, in part because a disability can cost you higher-earning years that would boost your calculated benefit. After an [2.5 percent](https://www.aarp.org/retirement/social-security/info-2024/cola-set-for-2025.html) cost-of-living adjustment, the estimated average monthly retirement and SSDI benefits in January 2025 are $1,976 and $1,585, respectively, according to SSA data. If you have an online [My Social Security account](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/ "MySocialSecurity account"), you can check your projected retirement and disability benefit amounts.

#### Keep in mind

*   SSDI benefits can be reduced if you are collecting other public disability payments, such as state disability benefits or [workers' compensation](https://www.aarp.org/retirement/social-security/questions-answers/workers-compensation-settlement-ssdi/ "workers compensation"). There is no reduction for private benefits, such as payouts from commercial disability insurance.
*   If you are still getting SSDI when you reach full retirement age, your disability benefit [converts to a retirement benefit](https://www.aarp.org/retirement/social-security/questions-answers/disability-benefits-retirement-age/ "Social Security benefits and retirement age"), usually at the same amount.
*   The earnings-based benefit calculation does not apply to [Supplemental Security Income](https://www.aarp.org/retirement/social-security/questions-answers/what-is-ssi/ "SSI") (SSI), the other SSA-run benefit program serving people with disabilities. [SSI eligibility](https://www.aarp.org/retirement/social-security/questions-answers/ssi-eligible/ "SSI eligibility") is based on financial need and benefit amounts are set by the federal government, without regard to a recipient’s work history.

[%{postComment}%](https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation.html#comments_widget_id)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 269: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 270](https://www.aarp.org/retirement/social-security/info-2021/ssdi-benefit-calculation/)
