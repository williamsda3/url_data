Title: If I’m still working at age 65, when do I sign up for Medicare?

URL Source: https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/

Published Time: 2023-03-01T05:00:00+0000
...
[Skip to content](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/#aarp-u-end-of-header)
...
[](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/#)[](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/#)
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/inscripcion-medicare-mientras-trabajo/)

Published March 01, 2023

/ Updated October 19, 2023

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working.html&related=CreateTheGood&text=)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working.html&title=)

If you aren’t already receiving Social Security benefits at age 65, you won’t be signed up automatically, so you’ll have to decide [when you want to enroll](https://www.aarp.org/health/medicare-insurance/info-2020/enrolling-in-medicare.html "enrolling in medicare").
...
Many people enroll in [Medicare Part A](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-part-a/ "what is medicare part a") at 65, even with employer coverage because it’s [premium -free](https://www.aarp.org/health/medicare-qa-tool/what-is-the-premium-for-part-a/ "premium for part a") as long as you or your spouse have paid at least 40 quarters of [Medicare taxes](https://www.aarp.org/health/medicare-qa-tool/medicare-payroll-taxes/ "medicare payroll taxes"). However, you may decide to wait if you want to continue contributing pretax dollars to a [health savings account](https://www.aarp.org/health/medicare-qa-tool/health-savings-account/ "medicare and HSA") (HSA). You can’t make new HSA contributions after you enroll in Medicare.

Those who have access to employer-based health insurance often delay signing up for [Medicare Part B](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-part-b/ "what is medicare part b") while they’re still working. That way, they don’t have to pay premiums for both Medicare and the employer coverage. Part B premiums are $164.90 a month in 2023, $174.70 in 2024 and [more for high earners](https://www.aarp.org/health/medicare-insurance/info-2022/how-to-lower-medicare-premiums.html "income and medicare premiums").
...
**Medigap also might be affected.** If you sign up for Part B while you still have coverage from a large employer, you may have a difficult time getting a [Medicare supplement policy](https://www.aarp.org/health/medicare-qa-tool/what-is-medigap-insurance/ "what is medigap"), also called Medigap, after that employer coverage ends.

You have a right to buy any Medigap policy available in your state regardless of your health within six months of enrolling in Part B when you’re 65 or older. But if you enrolled in Part B while working for a large employer and don’t buy a Medigap policy until after that six months have passed, insurers in most states can reject you for coverage or charge more because of a [preexisting health condition](https://www.aarp.org/health/health-insurance/info-2021/avoid-medigap-mistakes.html "avoid medigap mistakes"), except in special circumstances.
...
You generally need to sign up for Medicare Parts A and B during your [initial enrollment period (IEP)](https://www.aarp.org/health/medicare-insurance/info-2022/initial-enrollment-period.html "initial enrollment period"), which begins three months before and ends three months after the month you turn 65. If you don’t, you could end up with large coverage gaps.
...
**Your first priority should be** to ask the employer whether you’re required to sign up for Medicare when you turn 65 or if you’re eligible to receive Medicare earlier [because of a disability](https://www.aarp.org/retirement/social-security/info-2022/medicare-for-ssdi-beneficiaries.html "medicare for disability beneficiaries"). Find out exactly how the employer plan will fit in with Medicare. If you’re not required to sign up for Medicare, ask the employer to provide ﻿the decision in writing.

**What about Medigap** when working for a small employer? When Medicare is primary coverage and the employer plan is secondary, you have a guaranteed issue right to buy a Medigap policy within 63 days of losing that coverage, regardless of preexisting conditions. In this situation, signing up for Medicare Part B when you also have employer insurance won’t jeopardize your chances of [buying a Medigap policy](https://www.aarp.org/health/medicare-insurance/info-2017/choosing-right-medigap-plan.html "choosing medigap plans") after your employment ends.

### What if I get COBRA or retiree health coverage?

You still need to sign up for Medicare during your initial enrollment period if you continue your [former employer’s health coverage through COBRA](https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/ "cobra and medicare") or if you have retiree health insurance.

Medicare becomes your primary coverage when you turn 65; [COBRA coverage is secondary](https://www.aarp.org/health/health-insurance/info-2020/avoid-costly-medicare-mistakes.html "medicare mistakes"). You also could face coverage gaps if you don’t sign up for Medicare. [Retiree health insurance benefits](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/ "medicare and retiree insurance") are generally secondary to Medicare, too.

You or your spouse must be actively working for the employer that provides your health insurance if you want to delay Medicare enrollment and qualify for a special enrollment period later.

ARTICLE CONTINUES AFTER ADVERTISEMENT

#### Keep in mind  ﻿

**A caveat on Part A.** Many people sign up for Medicare Part A at 65, even if they’re working for a large employer, if it’s premium-free. But if you have a high-deductible health insurance policy and you want to continue contributing to a [health savings account](https://www.aarp.org/money/taxes/info-2020/hsa-tax-advantages.html "HSA advantages"), you may want to delay enrolling in Part A.

**You can’t do both simultaneously.** After you enroll in either Medicare Part A or B, you can’t contribute to an HSA. Some people insured through large employers choose to delay signing up for both parts of Medicare until after they leave the job that provides health insurance. When that happens, you have up to eight months to enroll in Medicare Part B or else you’ll end up with [permanent late enrollment penalties](https://www.aarp.org/health/medicare-qa-tool/how-much-is-the-part-b-late-enrollment-penalty/ "late enrollment penalty").
...
**A sample calculation.** If you retire in September and your Part A coverage will take effect six months before then, you can make three months’ worth of contributions to the HSA. That would be $1,212.48 if you’re 55 or older in 2023 and have self-only health insurance coverage.

[Return to Medicare Q&A main page](https://www.aarp.org/health/medicare-qa-tool/ "Medicare Q&A Tool")

[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/#comments_widget_id)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 281: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 282](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/)
