Title: If I have COBRA, do I need to sign up for Medicare?

URL Source: https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/

Published Time: 2022-08-17T04:00:00+0000
...
[Skip to content](https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/#)

[](https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/#)[](https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/#)

[AARP Medicare Question and Answer Tool](https://www.aarp.org/health/medicare-qa-tool/)

Do I need to sign up for Medicare if my former employer’s coverage continues under COBRA?
=========================================================================================
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/cobertura-cobra-medicare-misma-vez/)

Published August 17, 2022

/ Updated January 11, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time.html&related=CreateTheGood&text=)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time.html&title=)
...
You’ll need to sign up for Medicare during your [initial enrollment period](https://www.aarp.org/health/medicare-insurance/info-2022/initial-enrollment-period.html "medicare initial enrollment period"), which begins three months before the month you turn 65 and ends three months after your birthday month.
...
You can delay signing up for Medicare without penalty only if [you or your spouse is still working](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/ "medicare if still working") and have health insurance from a _current_ employer. Even though COBRA is the same coverage as you had when working, it acts differently under Medicare rules because you or your spouse are no longer actively working in that job.

If you postponed signing up for Medicare past 65 because you or your spouse was still working, you qualify for a [special enrollment period](https://www.aarp.org/health/medicare-insurance/info-2022/special-enrollment-period.html "special enrollment period") any time while working in that job and for up to eight months afterward. You should enroll in Medicare Part A and Part B before the end of that special enrollment period. If you don't, you may have to pay a [late enrollment penalty](https://www.aarp.org/health/medicare-qa-tool/how-much-is-the-part-b-late-enrollment-penalty/ "late enrollment penalty") and you may have to wait until the [general enrollment period](https://www.aarp.org/health/medicare-qa-tool/what-are-the-medicare-enrollment-periods/ "general enrollment period"), Jan. 1 to March 31, to sign up for Part B.

You may also have coverage gaps. When you’re 65 or older and you and your spouse are no longer working, Medicare pays your health care claims first, and your other coverage — whether COBRA, a [Medigap policy](https://www.aarp.org/health/medicare-insurance/info-2023/guide-to-medigap-plans.html "guide to medigap") or retiree coverage — pays for expenses and services that Medicare doesn’t cover. The secondary coverage may pay for Medicare’s deductibles, copayments and other [out-of-pocket costs](https://www.aarp.org/health/medicare-qa-tool/does-medicare-cover-all-health-care-costs/).
...
**Prescription drug coverage.** The rules are different for [Medicare Part D prescription plans](https://www.aarp.org/health/medicare-insurance/info-2018/part-d-prescription-drugs.html "medicare part d"). If you have COBRA or retiree drug coverage that is at least as good as Part D, which Medicare considers “creditable coverage,” you don’t need to enroll in Part D as long as you have that coverage, even if it’s not from a current employer. Ask your plan if the coverage is creditable.

After losing that coverage, you’ll have 62 days to enroll in Part D without a [late enrollment penalty](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible// "medicare part d late enrollment penalty").

**Medigap plans.** You can buy any Medigap policy in your area, regardless of your health, within six months of enrolling in Medicare Part B. Otherwise, Medigap insurers can reject you for coverage or charge more if you have preexisting conditions. Within 63 days of losing health insurance that provides secondary coverage to Medicare, such as COBRA, you have a [guaranteed issue right.](https://www.aarp.org/health/health-insurance/info-2021/avoid-medigap-mistakes.html "avoid these medigap mistakes")
...
[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/#comments_widget_id)
...
[Monthly premiums, other out-of-pocket expenses can add up](https://www.aarp.org/health/medicare-insurance/info-2018/out-of-pocket-prescription-costs.html)
     ...
     [![Image 269: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 270: woman at library using the computer](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/enrolling-in-medicare2.coreimg.50.932.jpeg/content/dam/aarp/health/medicare-and-medicaid/2021/1140-woman-library-computer.jpg)](https://www.aarp.org/health/medicare-insurance/info-2020/enrolling-in-medicare.html "How to Sign Up: A Guide to Medicare Enrollment
")
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 273: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 274](https://www.aarp.org/health/medicare-qa-tool/cobra-and-medicare-at-the-same-time/)
