Title: When can I join or switch a Part D prescription drug plan?

URL Source: https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/

Published Time: 2022-02-17T05:00:00+0000

Markdown Content:
When Can I Join or Switch a Part D Prescription Drug Plan?
===============
                                                      

[Skip to content](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/#)

[](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/#)[](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/#)
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/inscripcion-medicare-parte-d/)

Published February 17, 2022

/ Updated January 16, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan.html&related=CreateTheGood&text=)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan.html&title=)
...
You have two ways to get coverage: [Buy a stand-alone Part D prescription drug plan](https://www.aarp.org/health/medicare-insurance/info-2018/part-d-prescription-drugs.html "medicare part d for prescription drugs"), or [sign up for a Medicare Advantage plan](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-advantage/ "enrolling in medicare advantage") that combines medical and drug coverage. Private insurance companies that Medicare regulates offer both types of plans. Keep in mind, you can enroll only during certain times:

*   [**Initial enrollment period**](https://www.aarp.org/health/medicare-insurance/info-2022/initial-enrollment-period.html "medicare initial enrollment period"), the seven-month period that begins ﻿on the first day of the month that falls three months before the month you turn 65 and lasts for three months after﻿ the birthday month.

*   [**Open enrollment period**](https://www.aarp.org/health/medicare-insurance/info-2022/open-enrollment.html "medicare open enrollment"), which runs annually from Oct. 15 to Dec. 7, with coverage beginning Jan. 1. You also can switch to a different Part D or Medicare Advantage plan during this time.​
...
*   Receive financial assistance from the [Part D Extra Help program](https://www.aarp.org/health/medicare-qa-tool/financial-help-for-medication-costs/ "medicare part d extra help"). You can switch Part D plans as much as once per calendar quarter during the first three quarters of the year.

*   Find a Medicare Advantage or Part D plan in your area that received a [five-star quality rating](https://www.aarp.org/health/medicare-qa-tool/what-are-star-ratings/ "medicare star ratings") from the Centers for Medicare ﻿& Medicaid Services (CMS). You can join that plan during the five-star special enrollment period, which lasts from Dec. 8 through Nov. 30 of the following year. It can be used once a year. Enrollment takes effect the first day of the month after the plan receives the enrollment request.

For more information about special enrollment periods, visit [Medicare.gov](https://www.medicare.gov/Pubs/pdf/11219-understanding-medicare-part-c-d.pdf "medicare.gov on medicare part d").
...
See [Special Enrollment Periods](https://www.medicare.gov/basics/get-started-with-medicare/get-more-coverage/joining-a-plan/special-enrollment-periods "medicare special enrollment periods") at Medicare.gov for a list of the eligible situations when you can sign up or switch plans.

If you already have a Medicare Advantage plan, you can switch to another plan or switch from MA to [original Medicare](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/ "what is original medicare") and get a Part D plan during the Medicare Advantage open enrollment period from Jan. 1 to March 31 each year.

#### Keep in mind﻿﻿

If you don’t sign up for Part D when you’re first eligible and you don’t have other creditable coverage, you may have to pay a [late enrollment penalty](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/ "late enrollment penalty").

[Return to Medicare Q&A main page](https://www.aarp.org/health/medicare-qa-tool/ "Medicare Q&A Tool")

[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/#comments_widget_id)
...
More on Medicare
     ...
     [![Image 275: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 276: Medicare Card](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/choosing-best-drug-plan-for-me1.coreimg.50.932.jpeg/content/dam/aarp/health/medicare_insurance/2019/06/1140-medicare-card.jpg)](https://www.aarp.org/health/medicare-qa-tool/choosing-best-drug-plan-for-me/ "How Can I Pick the Best Prescription Plan For My Needs?
")
...
[It needs to cover all your medicines at the lowest cost](https://www.aarp.org/health/medicare-qa-tool/choosing-best-drug-plan-for-me/)
     ...
     [![Image 277: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 278: Medicare Card](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/what-are-costs-for-part-d2.coreimg.50.932.jpeg/content/dam/aarp/health/medicare_insurance/2019/06/1140-medicare-card.jpg)](https://www.aarp.org/health/medicare-qa-tool/what-are-costs-for-part-d/ "What Costs Will I Have to Pay in a Medicare Part D Plan?
")
...
[Out-of-pocket costs go beyond your premium payments](https://www.aarp.org/health/medicare-qa-tool/what-are-costs-for-part-d/)
     ...
     [![Image 279: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 280: cartoon hand pointing to a computer monitor that has the medicare dot com webpage on it along with a magnifying glass](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/what-are-the-medicare-enrollment-periods3.coreimg.50.932.jpeg/content/dam/aarp/health/medicare_insurance/2022/02/1140-medicare-01-overview.jpg)](https://www.aarp.org/health/medicare-qa-tool/what-are-the-medicare-enrollment-periods/ "What Are the Three Enrollment Periods for Medicare?
")

[What Are the Three Enrollment Periods for Medicare?](https://www.aarp.org/health/medicare-qa-tool/what-are-the-medicare-enrollment-periods/)

[You can sign up for Medicare only during these times](https://www.aarp.org/health/medicare-qa-tool/what-are-the-medicare-enrollment-periods/)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 281: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 282](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/)
