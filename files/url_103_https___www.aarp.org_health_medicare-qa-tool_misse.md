Title: What happens if I miss Medicare open enrollment?

URL Source: https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment/

Published Time: 2022-12-06T05:00:00+0000

Markdown Content:
What to Do if You Miss Medicare Open Enrollment Period
===============
                                                     

[Skip to content](https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment/#)

[](https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment/#)[](https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment/#)
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/perder-periodo-de-inscripcion-abierta/)

Published December 06, 2022

/ Updated December 07, 2023

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment.html&related=CreateTheGood&text=What%20happens%20if%20I%20miss%20Medicare%20open%20enrollment?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment.html&title=What%20happens%20if%20I%20miss%20Medicare%20open%20enrollment?)

Open enrollment, your opportunity to choose a [Part D prescription drug plan](https://www.aarp.org/health/medicare-insurance/info-2018/part-d-prescription-drugs.html "medicare part d for prescription drugs") or [Medicare Advantage plan](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-advantage/ "what is medicare advantage") for the coming year, is Oct. 15 to Dec. 7. If you miss this [annual open enrollment period](https://www.aarp.org/health/medicare-insurance/info-2022/open-enrollment.html "medicare open enrollment"), you’ll be reenrolled automatically in your current plan as long as it’s offered in your area.
...
If you have a Medicare Advantage plan and want to [switch to another plan](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/ "switching medicare advantage plans if unhappy") that provides better coverage for your doctors or drugs — or leave Medicare Advantage for [original Medicare](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/ "what is original medicare") — several opportunities exist that may let you make changes after open enrollment, including:
...
**Be aware:** If you leave Medicare Advantage for original Medicare and want a Medigap policy to help cover [Medicare’s deductibles and copayments](https://www.aarp.org/health/medicare-qa-tool/what-is-medigap-insurance/ "what is medigap"), this supplemental coverage may not be guaranteed. Medigap insurers in most states can charge more or reject you because of preexisting conditions unless you [buy a Medigap policy during certain times](https://www.aarp.org/health/medicare-qa-tool/best-time-to-buy-a-medigap-policy/ "when to buy a medigap policy").

**During your first year in Medicare Advantage.** You can leave Medicare Advantage for original Medicare anytime during this 12-month trial period. You can also sign up for a Part D prescription drug plan and qualify for a special enrollment period to get Medigap coverage regardless of [preexisting conditions](https://www.aarp.org/health/medicare-qa-tool/medicare-preexisting-medical-conditions/ "medicare and preexisting medical conditions").
...
*   **Have a five-star plan in your area.** If a locally available Medicare Advantage plan has an overall [five-star quality rating](https://www.aarp.org/health/medicare-qa-tool/what-are-star-ratings/ "what are medicare star ratings") from the government, you can switch to that plan one time outside of open enrollment. Coverage begins the first day of the month after the plan receives your enrollment request. You can search for plans with a five-star rating using the [Medicare Plan Finder.](https://www.aarp.org/health/medicare-insurance/info-2022/advantage-enrollment.html "enrolling in medicare advantage plans")

*   **Qualify for a [special enrollment period](https://www.medicare.gov/Pubs/pdf/11219-understanding-medicare-part-c-d.pdf "special enrollment periods").** For example, you can switch plan﻿s if you move into or out of a long-term care facility or if you qualify to join a [chronic condition special needs plan](https://www.aarp.org/health/medicare-insurance/info-2021/chronic-conditions-benefits.html "medicare chronic conditions benefits").
...
If you discover that another Part D plan has better coverage for your medications, or if your doctor prescribes a new drug that isn’t covered in [your plan’s formulary](https://www.aarp.org/health/medicare-qa-tool/medicare-formulary-rights-protections/ "medicare formulary"), you may have opportunities [to change plans](https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/ "can you change your medicare part d plan") after Dec. 7. If you:

*   **Move out of your plan’s service area** — you usually have up to two months to change to another plan.

*   **Receive financial assistance from the** [**Extra Help program**](https://www.aarp.org/health/medicare-qa-tool/financial-help-for-medication-costs/ "medicare extra help for prescription costs"), which helps people with low incomes pay Part D premiums and [out-of-pocket costs](https://www.aarp.org/health/medicare-qa-tool/what-are-costs-for-part-d/ "costs for medicare part d") — you can change Part D plans as often as once per quarter.
...
*   **Qualify for a** [**special enrollment period**](https://www.medicare.gov/basics/get-started-with-medicare/get-more-coverage/joining-a-plan/special-enrollment-periods "medicare special enrollment periods") — for example, if your Part D plan terminates its contract with Medicare.

ARTICLE CONTINUES AFTER ADVERTISEMENT

### What happens if I don’t have a Part D or Medicare Advantage plan?

You can sign up outside of open enrollment:

*   **During your seven-month** [**initial enrollment period**](https://www.aarp.org/health/medicare-insurance/info-2022/initial-enrollment-period.html "medicare initial enrollment period") for Medicare, the three months before the month you turn 65 until three months after your birthday month.

*   **Within two months** of losing medical insurance from your employer or union.

*   **Within two months** of losing drug coverage considered at least as good as Part D, called “creditable coverage.” This creditable coverage may be from an employer, a retiree plan, [Tricare](https://www.aarp.org/health/medicare-qa-tool/military-tricare-medicare-spouse/ "medicare and tricare military insurance") or another source.

#### Keep in mind

Starting on Jan. 1, 2024, if you sign up for Part A or Part B because of an [exceptional condition](https://www.cms.gov/files/document/application-medicare-part-part-b-special-enrollment-period-exceptional-conditions.pdf "medicare and exceptional conditions"), such as being unable to sign up in time because of a natural disaster, misinformation from your employer or losing Medicaid coverage, you’ll have two months to join a Medicare Advantage plan or a Part D prescription drug plan. Coverage will start on the first of the month after the plan receives your request to join.

If you don’t sign up for prescription drug coverage from a Part D or Medicare Advantage plan within these time frames and don’t have other creditable drug coverage, you may have to pay a [Part D late enrollment penalty](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/ "medicare part d late enrollment penalty") when you eventually enroll.

One last thing to note: Part D and Medicare Advantage deadlines are different from deadlines for enrolling in original Medicare. You still have to sign up for Medicare Part A and Part B during [your initial enrollment period at age 65](https://www.aarp.org/health/medicare-qa-tool/turning-65-when-to-apply-for-medicare/ "when to apply for medicare") unless you or your spouse is still working and you have [health insurance from a current employer](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/ "medicare if you're still working"). You have up to eight months after losing employer health insurance to enroll in Medicare without a [Part B late enrollment penalty](https://www.aarp.org/health/medicare-qa-tool/how-much-is-the-part-b-late-enrollment-penalty/ "medicare part b late enrollment penalty").

[Return to Medicare Q&A main page](https://www.aarp.org/health/medicare-qa-tool/ "Medicare Q&A Tool")

[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment/#comments_widget_id)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 281: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 282](https://www.aarp.org/health/medicare-qa-tool/missed-medicare-open-enrollment/)
