Title: What happens to my Medicare coverage if I move to another state?

URL Source: https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/

Published Time: 2023-04-12T04:00:00+0000

Markdown Content:
Does Medicare Coverage Change if You Move to a New State?
===============
                                                      

[Skip to content](https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/#)

[](https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/#)[](https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/#)
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/cobertura-si-me-mudo-a-otro-estado/)

Published April 12, 2023

/ Updated March 07, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states.html&related=CreateTheGood&text=What%20happens%20to%20my%20Medicare%20coverage%20if%20I%20move%20to%20another%20state?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states.html&title=What%20happens%20to%20my%20Medicare%20coverage%20if%20I%20move%20to%20another%20state?)

If you move anywhere within the United States, you won’t lose your [original Medicare](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/ "what is original medicare") coverage as long as your new health care facility, doctor or other provider [accepts Medicare](https://www.aarp.org/health/medicare-qa-tool/define-term-medicare-assignment/ "what is medicare assignment"). But if you have Part D prescription coverage, a Medicare Advantage plan or Medigap supplemental insurance from a private company, the rules change.

Make yourself a note to update your mailing address with Medicare once you’ve moved, so bills, correspondence, your [Medicare Summary Notice](https://www.aarp.org/health/medicare-qa-tool/medicare-summary-notice/ "medicare summary notice") and other statements go to the right address. To do this, you’ll need to contact the Social Security Administration even if you don’t receive Social Security benefits; [SSA handles all Medicare enrollment](https://www.aarp.org/retirement/social-security/questions-answers/ssa-medicare-work-together/ "social security and medicare") issues.

You can update your information in your [My Social Security account](https://www.aarp.org/retirement/social-security/info-2020/open-your-online-account.html "online social security account"), call 800-772-1213 or contact a [Social Security office](https://www.ssa.gov/locator/ "social security office locator"). If you get [Railroad Retirement Board benefits](https://www.aarp.org/health/medicare-qa-tool/medicare-and-railroad-retirement-benefits/ "medicare and railroad retirement benefits"), call 877-772-5772. Take this time to update other personal information, such as your phone number or email address, in your [online Medicare account.](https://www.aarp.org/health/medicare-qa-tool/medicare-online-account/ "online medicare account")
...
[Part D](https://www.aarp.org/health/medicare-insurance/info-2018/part-d-prescription-drugs.html "medicare part d for prescription drugs") service areas typically are statewide or can extend to parts of neighboring states. [Medicare Advantage plans’](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-advantage/ "medicare advantage") service areas vary by county. Use the Medicare Plan Finder to search for [Part D](https://www.aarp.org/health/medicare-insurance/info-2022/part-d-enrollment.html "medicare part d enrollment") and [Medicare Advantage](https://www.aarp.org/health/medicare-insurance/info-2022/advantage-enrollment.html "medicare advantage enrollment") plans in your new area by ZIP code.

For both Part D and [Medicare Advantage](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/), moving out of a plan’s service area qualifies you for a [special enrollment period](https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/) (SEP) of at least two months to get a new plan. You may also qualify if you move within your plan's service area but there are different plan options in your new location.
...
You can also switch Part D or Medicare Advantage plans [during open enrollment](https://www.aarp.org/health/medicare-insurance/info-2022/open-enrollment.html "medicare open enrollment"), which runs each year from Oct. 15 to Dec. 7 for coverage starting Jan. 1.
...
You usually don’t have to switch [Medigap plans](https://www.aarp.org/health/medicare-qa-tool/what-is-medigap-insurance/ "what is medigap") if you move, but you should notify the insurer of your new address. Some insurers let you keep the rate based on the state where you originally applied for Medigap. Others may change your premiums to coincide with their coverage in a different ZIP code.

[Medigap consumer protections](https://www.aarp.org/health/health-insurance/info-2021/avoid-medigap-mistakes.html "avoid these medigap mistakes") vary from state to state, so you may have additional options depending on where you move. For example, Connecticut, Massachusetts and New York allow you to buy a Medigap policy anytime regardless of your health.
...
[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/#comments_widget_id)
...
[Which path you take will determine how you get your medical care — and how much it costs](https://www.aarp.org/health/medicare-insurance/info-2020/original-medicare-vs-advantage.html)
     ...
     [![Image 277: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 278: There are steps you can take to avoid moving scams.](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/moving2.coreimg.50.932.jpeg/content/dam/aarp/money/scams_fraud/2023/12/1140-moving-scams.jpg)](https://www.aarp.org/money/scams-fraud/info-2019/moving.html "Prevent Moving Scams With These Tips")

[Prevent Moving Scams With These Tips](https://www.aarp.org/money/scams-fraud/info-2019/moving.html)

[Take these steps to protect yourself from moving scams](https://www.aarp.org/money/scams-fraud/info-2019/moving.html)

     [![Image 279: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 280: Medicare Card](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/medicare-if-living-outside-united-states3.coreimg.50.932.jpeg/content/dam/aarp/health/medicare_insurance/2019/06/1140-medicare-card.jpg)](https://www.aarp.org/health/medicare-qa-tool/medicare-if-living-outside-united-states/ "Can I ﻿Get Medicare if I’m ﻿Not ﻿Living in the U.S. ﻿Now?")

[Can I Get Medicare if I’m Not Living in the U.S. Now?](https://www.aarp.org/health/medicare-qa-tool/medicare-if-living-outside-united-states/)

[Generally, yes, but you’ll need to check out the details](https://www.aarp.org/health/medicare-qa-tool/medicare-if-living-outside-united-states/)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 281: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 282](https://www.aarp.org/health/medicare-qa-tool/what-happens-to-medicare-if-you-move-states/)
