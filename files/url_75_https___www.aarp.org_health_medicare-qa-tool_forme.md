Title: How does retiree health insurance work with Medicare?

URL Source: https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/

Published Time: 2017-06-28T04:00:00+0000

Markdown Content:
What to Know About Retiree Health Insurance and Medicare
===============
                                                     

[Skip to content](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/#)

[](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/#)[](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/#)
...
[En español](http://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/tengo-que-inscribirme-en-medicare-a-los-65.html)

Published June 28, 2017

/ Updated February 13, 2023

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b.html&related=CreateTheGood&text=How%20does%20retiree%20health%20insurance%20work%20with%20Medicare?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b.html&title=How%20does%20retiree%20health%20insurance%20work%20with%20Medicare?)
...
Yes, people who have company, government or union health benefits in retirement generally need to sign up for Medicare during their [initial enrollment period](https://www.aarp.org/health/medicare-insurance/info-2022/initial-enrollment-period.html "medicare initial enrollment period"), which begins three months before the month you turn 65 and ends three months after your birthday month.﻿ It’s important to consult with your plan administrator about the rules before you turn 65.

If you don’t sign up for Medicare [Part A](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-part-a/ "what is medicare part a") and [Part B](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-part-b/ "what is medicare part b") during your initial enrollment period, you could face three negative consequences:

**1\. Penalty for late enrollment.** If you don’t have health insurance from a current employer — either your own or your spouse’s — you’ll have to pay a [late enrollment penalty](https://www.aarp.org/health/medicare-qa-tool/how-much-is-the-part-b-late-enrollment-penalty/ "medicare part b late enrollment penalty") if you sign up for Medicare Part B later. Even if you have good retiree health benefits in the beginning, the cost and coverage can change over time and your health care needs may change, too.
...
The rule is different for [federal retiree health insurance](https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/ "medicare for retiring federal employees"), which can continue to be primary coverage.

**3\. Delay in enrollment.** Having retiree coverage doesn’t qualify you for a [special enrollment period](https://www.aarp.org/health/medicare-insurance/info-2022/special-enrollment-period.html "medicare special enrollment period") to sign up for Medicare later, so you may need to wait until the annual general enrollment period, which runs Jan. 1 to March 31. Your coverage starts the [month after you enroll](https://www.aarp.org/health/medicare-insurance/info-2022/enrollment-coverage-gaps.html "medicare coverage gaps"). Before 2023, your coverage didn’t start until July 1 if you signed up during the general enrollment period.
...
The details of retiree coverage can vary a lot by company. However, some plans cover expenses that [aren’t included in Medicare](https://www.aarp.org/health/medicare-insurance/info-2018/services-not-covered.html "services not covered by medicare"), such as dental and vision care. Contact your retiree plan administrator for details.

Retiree insurance may not cover all of [Medicare’s out-of-pocket costs](https://www.aarp.org/health/medicare-qa-tool/does-medicare-cover-all-health-care-costs/ "does medicare cover all health care costs"). But if you have retiree coverage, you typically don’t need to buy a [Medicare supplement policy](https://www.aarp.org/health/medicare-qa-tool/what-is-medigap-insurance/ "what is medigap"), better known as Medigap.
...
**Consider Part A.** If you aren’t required to [pay a premium for Part A](https://www.aarp.org/health/medicare-qa-tool/what-is-the-premium-for-part-a/ "what is the premium for medicare part a"), you may want to sign up for Medicare at age 65 or when you leave your federal job if you work beyond 65. The federal [Office of Personnel Management](https://www.opm.gov/healthcare-insurance/healthcare/medicare/medicare-vs-fehb-enrollment/ "medicare vs federal insurance enrollment") encourages federal retirees to enroll in Part A if their premiums are free.

Think carefully about whether you want to delay enrolling in Part B, because doing so could come with a penalty if you change your mind later. Part B [costs $164.90 a month](https://www.aarp.org/health/medicare-qa-tool/what-are-costs-for-part-b/ "what are the costs for medicare part b") in 2023. It costs more if you’re single and your modified adjusted gross income is higher than $97,000 or higher than $194,000 if married and filing jointly.
...
Medicare will pay some of the costs for products and services that your FEHB plan may not cover, including specific medical equipment and supplies, home health care, and orthopedic and prosthetic devices. See the Office of Personnel Management’s [FEHB and Medicare guide](https://www.opm.gov/healthcare-insurance/healthcare/medicare/coordination-of-medicare-and-fehb-benefits/ "medicare and federal health insurance guide") for more information about coordinating the two types of coverage.

#### **Keep in mind**

**Prescription coverage.** The rules are different for [Part D prescription drug coverage](https://www.aarp.org/health/medicare-insurance/info-2018/part-d-prescription-drugs.html "medicare part d for prescription drugs"). In this case, it doesn’t matter whether your drug coverage is from an active employer, a former employer or another source. If you have prescription coverage that’s considered to be at least as good as Part D, which the federal government considers “creditable” coverage, you don’t have to sign up for Part D.
...
**Retiree coverage isn’t guaranteed for life.** If you lose that drug coverage, you’ll be eligible for a two-month special enrollment period when you can sign up for Part D coverage without a [late enrollment penalty](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/ "medicare late enrollment penalty").

[Return to Medicare Q&A main page](https://www.aarp.org/health/medicare-qa-tool/ "Medicare Q&A Tool")

[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/#comments_widget_id)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 289: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 290](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/)
