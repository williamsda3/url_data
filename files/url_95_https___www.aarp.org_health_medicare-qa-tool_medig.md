Title: Can I get Medigap insurance if I’m under 65?

URL Source: https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65/

Published Time: 2022-11-15T05:00:00+0000

Markdown Content:
Can You Get Medicare Supplemental Insurance Under 65?
===============
                                                     

[Skip to content](https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65/#)

[](https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65/#)[](https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65/#)

[AARP Medicare Question and Answer Tool](https://www.aarp.org/health/medicare-qa-tool/)

Can I get Medigap insurance if I’m under 65?
============================================
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/adquirir-seguro-medigap-menor-de-65/?intcmp=AE-HLTH-TOSPA-TOGL-ES)

Published November 15, 2022

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65.html&related=CreateTheGood&text=)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65.html&title=)

If you qualify for Medicare before age 65, your ability to get a Medigap policy depends on the state where you live.

[Medicare supplement policies](https://www.aarp.org/health/medicare-qa-tool/what-is-medigap-insurance/ "what is medigap"), also known as Medigap, help pay Medicare’s deductibles, copayments and other out-of-pocket costs. People 65 and older can get any Medigap policy available in their area at the best rates if they buy at certain times — such as within six months after signing up for Medicare Part B.

Members only

                     

**Roadblocks if you’re younger.** Those federal protections don’t apply to people who are younger than 65 and qualify for Medicare because of kidney failure, also known as [end-stage renal disease](https://www.aarp.org/health/medicare-qa-tool/eligible-for-medicare-with-kidney-disease/ "medicare and kidney disease") (ESRD), or [another disability](https://www.aarp.org/retirement/social-security/info-2022/medicare-for-ssdi-beneficiaries.html "medicare and disability"). This is where state protections can kick in.
...
Without a Medigap policy or other supplemental coverage, such as employer or retiree health insurance, you may have to pay [Medicare’s deductibles and copayments](https://www.aarp.org/health/medicare-insurance/info-2018/out-of-pocket-prescription-costs.html "medicare part d costs") yourself, which can add up quickly﻿, depending on your medical condition.

**An example.** Even though [Medicare Part B](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-part-b/ "what is medicare part b") covers outpatient dialysis for people with kidney failure, without other supplemental coverage you’ll have to pay 20 percent of the cost — called [Part B coinsurance](https://www.aarp.org/health/medicare-qa-tool/what-are-costs-for-part-b/ "medicare part b costs"). The American Kidney Fund estimates that Part B coinsurance can cost dialysis patients $10,000 or more out of pocket each year. To make matters worse, not having supplemental coverage could jeopardize your chance to get on a kidney transplant list.
...
To find out more about your state’s rules, contact your [State Health Insurance Assistance Program](https://www.shiphelp.org/ "state health insurance programs") (SHIP) or your [state insurance department](https://content.naic.org/state-insurance-departments "state insurance departments").
...
![Image 275: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg)    ![Image 276: US Map showing which states have Medigap protections for people under 65](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/medigap-insurance-under-65/_jcr_content/root/container_main/container_body_main/container_body2/container_body_cf/body_two_cf_one/par6/articlecontentfragme/cfimage.coreimg.50.932.jpeg/content/dam/aarp/health/medicare-and-medicaid/2022/11/1140-medigap-state-map-11-22.jpg) 
...
**And you get more protections.** You also could qualify for federal “[guaranteed issue rights](https://www.aarp.org/health/health-insurance/info-2021/avoid-medigap-mistakes.html "avoid medigap mistakes")” (also called “Medigap protections”), which require insurers to offer you a Medigap policy in certain situations without subjecting you to health questions or charging more based on past or present health problems. You may qualify for additional state protections too.

#### **Keep in mind**

Even if you can’t buy a Medigap policy before age 65, you might consider enrolling in a [Medicare Advantage plan](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-advantage/ "what is medicare advantage"), an alternative to original Medicare. Medicare officials must approve each plan, and they must cover everything that Medicare Part A and Part B cover, albeit with different deductibles and copayments. Most Medicare Advantage plans cover prescription drugs too.

These plans usually have provider networks, which means that if your doctor or preferred hospital is out of network, you may not be covered or could be charged more. So make sure your care team is part of the plan’s network and that the plan covers any medications you take. You can use the [Medicare Plan Finder](https://www.aarp.org/health/medicare-insurance/info-2022/advantage-enrollment.html "medicare advantage enrollment") to compare all costs and coverage for the plans available in your area.
...
Some Medicare Advantage plans specialize in [certain chronic conditions](https://www.aarp.org/health/medicare-insurance/info-2021/medicare-advantage-and-chronic-conditions.html "medicare chronic conditions"), such as diabetes, heart failure and other cardiovascular disorders, and kidney failure.

You can enroll in a Medicare Advantage plan when you first become eligible for Medicare﻿, and you can switch plans each year during [open enrollment](https://www.aarp.org/health/medicare-insurance/info-2022/open-enrollment.html "medicare open enrollment"), which runs from Oct. 15 through Dec. 7 for new coverage starting Jan. 1.

_Updated November 21, 2022_

[Return to Medicare Q&A main page](https://www.aarp.org/health/medicare-qa-tool/ "Medicare Q&A Tool")

[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65/#comments_widget_id)
...
More on Medicare
     ...
     [![Image 289: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 290: nurse and patient talking](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/medigap-insurance-under-65/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/chronic-conditions-benefits1.coreimg.50.932.jpeg/content/dam/aarp/health/medicare_insurance/2021/09/1140-medicare-chronic-conditions.jpg)](https://www.aarp.org/health/medicare-insurance/info-2021/chronic-conditions-benefits.html "New Medicare Benefits for Chronic Conditions")
...
[What to consider during open enrollment](https://www.aarp.org/health/medicare-insurance/info-2021/chronic-conditions-benefits.html)
     ...
     [![Image 291: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 292: stethoscope and calculator symbol for health care costs or medical insurance](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/medigap-insurance-under-65/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/medicare-savings-program2.coreimg.50.932.jpeg/content/dam/aarp/health/medicare-and-medicaid/2022/07/1140-medicare-savings-plan.jpg)](https://www.aarp.org/health/medicare-insurance/info-2022/medicare-savings-program.html "Medicare Savings Programs Can Save Enrollees Thousands
")

[Medicare Savings Programs Can Save Enrollees Thousands](https://www.aarp.org/health/medicare-insurance/info-2022/medicare-savings-program.html)

[AARP Foundation helps older adults sign up](https://www.aarp.org/health/medicare-insurance/info-2022/medicare-savings-program.html)

     [![Image 293: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 294: arrow shaped signs that say original and advantage pointing in opposite directions](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/medigap-insurance-under-65/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/original-medicare-vs-advantage3.coreimg.50.932.jpeg/content/dam/aarp/health/medicare-and-medicaid/2021/1140-2021-medicare-vs-advantage.jpg)](https://www.aarp.org/health/medicare-insurance/info-2020/original-medicare-vs-advantage.html "The Big Choice: Original Medicare vs. Medicare Advantage
")
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 295: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 296](https://www.aarp.org/health/medicare-qa-tool/medigap-insurance-under-65/)
