Title: What Is A My Social Security Account?

URL Source: https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/
...
[Skip to content](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/#aarp-u-end-of-header)
...
[](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/#)[](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/#)
...
[Back](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/#) [Cancel](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/#)
...
[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/que-es-cuenta-my-social-security/)

Published October 10, 2018

/ Updated July 15, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security.html&related=CreateTheGood&text=)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security.html&title=)
...
1.  Go to the [My Social Security sign-up page](https://www.ssa.gov/myaccount/ "mysocialsecurity signup link") and click on “Create an Account.”
...
3.  On the next screen, click on “Create an account" and enter an email address and language preference. You'll get an email from Login.gov with a link to confirm your email. At this stage you'll be prompted to create a [strong password](https://cms-pi.aarp.org/content/aarpe/en/home/home-family/personal-technology/info-2021/protect-your-devices.html) with at least 12 characters.
...
You’re now ready to use your My Social Security account! Each time you subsequently log in, you’ll need to go through the authorization process you previously selected (such as getting a code by text) and agree to the account terms of service.

### Get your Social Security statement online

Establishing a My Social Security account online is useful even if you’re not yet collecting retirement benefits. When you log in you’ll see your [Social Security statement](https://cms-pi.aarp.org/content/aarpe/en/home/retirement/social-security/info-2021/new-benefits-statement-features.html), which lists your annual earnings history and estimates your monthly benefit if you claim it at age 62, your [full retirement age](https://cms-pi.aarp.org/content/aarpe/en/home/retirement/social-security/questions-answers/social-security-full-retirement-age.html "full retirement age") or age 70.
...
The statement also provides estimates of [survivor benefits](https://cms-pi.aarp.org/content/aarpe/en/home/retirement/social-security/questions-answers/survivors.html) your spouse and children might get in the event of your death, and of what you are eligible to receive in [Social Security Disability Insurance](https://cms-pi.aarp.org/content/aarpe/en/home/retirement/social-security/questions-answers/disability-benefits.html "social security disability benefits") (SSDI) if a medical condition forces you to stop working.

You can also use My Social Security to request a [replacement Social Security card](https://cms-pi.aarp.org/content/aarpe/en/home/retirement/social-security/questions-answers/replacement-ss-card.html "replacement card") (in most states), and when you file a claim for benefits, you can track the [status of your application](https://www.ssa.gov/myaccount/ "track application status") online.
...
*   Set up or change [direct deposit of your benefit payment](https://cms-pi.aarp.org/content/aarpe/en/home/retirement/social-security/questions-answers/receiving-social-security-payments.html "set up direct deposit ").
*   Request a replacement Medicare card
*   Request a [replacement SSA-1099](https://www.aarp.org/retirement/social-security/questions-answers/getting-copy-ssa-1099-tax-form/ "replace social security 1099 tax form") or SSA-1042S, the tax forms Social Security sends out each January that summarize your benefits for the previous year
...
*   Obtain and print a [benefit verification letter](https://cms-pi.aarp.org/content/aarpe/en/home/retirement/social-security/questions-answers/social-security-benefits-letter.html "benefit verification letter"), which you can use as proof of income when applying for a loan or mortgage, or for government aid such as Supplemental Nutrition Assistance Program (SNAP) benefits or housing vouchers 
*   Report wages if you work and receive SSDI or [Supplemental Security Income](https://cms-pi.aarp.org/content/aarpe/en/home/retirement/social-security/questions-answers/what-is-ssi.html "SSI") (SSI)
*   Check the status of an appeal, including verifying a scheduled hearing date and time

If you are a [representative payee](https://cms-pi.aarp.org/content/aarpe/en/home/retirement/social-security/questions-answers/representative-payee.html "representative payee") managing benefits for someone else, you can use My Social Security to perform some of your duties, including setting up direct deposit for that person’s benefits, viewing messages and alerts they get from Social Security, and submitting accounting reports to SSA if required to do so.

### Some logins changing

If you signed up for My Social Security via Login.gov, you’ll continue using it whenever you sign in. If you created an account using ID.me, another service the SSA uses to provide secure login credentials, you can keep using that username and password.

However, Social Security is [phasing out logins created before Sept. 18, 2021](https://blog.ssa.gov/changes-are-coming-to-how-you-access-social-securitys-online-services/?utm_medium=email&utm_source=govdelivery "social security phasing out old logins"), on its own platform, SSA.gov. If you have one of these accounts, you will be prompted upon sign-in to link it with a Login.gov account. Select that option and follow the instructions to create new credentials you can use to access your account via Login.gov going forward.

#### **Keep in mind**

*   If you live abroad, you will need to use ID.me to set up and use a My Social Security account. You’ll find more information on the SSA’s [“Service Around the World” page](https://www.ssa.gov/foreign/ "social security services available aborad").  
    
*   If you have a [security freeze](https://www.aarp.org/money/scams-fraud/info-2023/check-credit.html "how to freeze your credit report ") or fraud alert on your credit report, you’ll need to temporarily lift it to create your account.
*   If you are [applying for benefits](https://cms-pi.aarp.org/content/aarpe/en/home/retirement/social-security/questions-answers/how-to-apply.html) online, you will be prompted during the process to sign in to your My Social Security account or create one if you have not yet done so. If you don’t complete the application in one sitting, you’ll need to use your account to get a reentry number to return to the saved application at any time.  
    

[%{postComment}%](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/#comments_widget_id)
...
[Is it possible to get a new Social Security number?](https://www.aarp.org/retirement/social-security/questions-answers/new-number/)

[How do I change the name on my Social Security card?](https://www.aarp.org/retirement/social-security/questions-answers/name-change-new-ss-card/)

[How can I use My Social Security Account to track my disability case?](https://www.aarp.org/retirement/social-security/questions-answers/track-disability-benefits-case/)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 269: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 270](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/)
