Title: What Is The Penalty For Being Late To Sign Up For Medicare?

URL Source: https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare/

Markdown Content:
What Is The Penalty For Being Late To Sign Up For Medicare?
===============
                                                     

[Skip to content](https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare/#)

[](https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare/#)[](https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare/#)
...
[Back](https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare/#) [Cancel](https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare/#)
...
[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/penalidad-por-inscripcion-tarde-a-medicare/)

Published October 10, 2018

/ Updated November 18, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare.html&related=CreateTheGood&text=Is%20there%20a%20penalty%20if%20I%27m%20late%20signing%20up%20for%20Medicare?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare.html&title=Is%20there%20a%20penalty%20if%20I%27m%20late%20signing%20up%20for%20Medicare?)
...
The penalty is applied to your premiums permanently, and it adds up. Medicare Part A, which covers hospitalization, comes at no cost for most recipients, but Part B carries premiums. The [base rate in 2025](https://www.aarp.org/health/medicare-insurance/info-2024/medicare-part-b-premium-increase.html "medicare part b premium twenty twenty five") is $185 a month. If you’re carrying a one-year late fee, you’ll pay an extra $222 for Part B in 2025 and bigger surcharges in future years as premiums rise.
...
*   If you are already collecting Social Security benefits at 65, the Social Security Administration (SSA) will [sign you up automatically](https://www.aarp.org/retirement/social-security/questions-answers/medicare-enroll-collecting-ss/ "Medicare enrollment while getting Social Security") for Medicare Parts A and B, but you can [opt out of Part B](https://www.medicare.gov/basics/get-started-with-medicare/sign-up/ready-to-sign-up-for-part-a-part-b "Medicare Part B information"). If you wish to do so, [contact the SSA](https://www.ssa.gov/agency/contact/ "Social Security Administration"). 
*   If you are not yet on Social Security, you have an [initial window](https://www.medicare.gov/basics/get-started-with-medicare/sign-up/when-does-medicare-coverage-start "Medicare coverage") of seven months, sandwiched around your 65th birthday, to [enroll in Medicare](https://www.ssa.gov/forms/ssa-1.html "Medicare enrollment").

[%{postComment}%](https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare/#comments_widget_id)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 261: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 262](https://www.aarp.org/retirement/social-security/questions-answers/is-there-a-penalty-if-late-applying-for-medicare/)
