Title: What are ‘prior authorization,’ ‘step therapy’ in Part D?

URL Source: https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions/

Published Time: 2022-09-21T04:00:00+0000

Markdown Content:
How Prior Authorization and Step Therapy Affect Part D
===============
                                                      

[Skip to content](https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions/#)

[](https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions/#)[](https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions/#)
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/restricciones-parte-d/)

Published September 21, 2022

/ Updated March 07, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions.html&related=CreateTheGood&text=What%20do%20prior%20authorization%20and%20step%20therapy%20mean%20in%20Part%20D%20drug%20plans?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions.html&title=What%20do%20prior%20authorization%20and%20step%20therapy%20mean%20in%20Part%20D%20drug%20plans?)

Some Medicare [Part D prescription plans](https://www.aarp.org/health/medicare-insurance/info-2018/part-d-prescription-drugs.html "medicare part d ") restrict coverage for certain medications, even if they’re on the plan’s list of covered drugs, which is called a [formulary](https://www.aarp.org/health/medicare-qa-tool/medicare-formulary-rights-protections/ "medicare formulary").
...
*   [Medicare Part B](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-part-b/ "what is medicare part b") usually covers treatment in a doctor’s office.

*   [Medicare Part A](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-part-a/ "what is medicare part a") or Part B may cover drug therapy in a hospital.
...
Step therapy often requires you to try a less expensive drug that’s proven effective for people with your condition before the plan will cover a more expensive, prescribed drug, even if both drugs are on the plan’s formulary. For example, some plans may require you to try a generic drug first and then a less expensive brand-name drug before they’ll cover a more expensive brand-name drug.

Your doctor can contact the plan to request an exception if they believe you’ll experience a reaction to the less expensive drug or it will be less effective.
...
If you or your doctor asks for an exception to the restriction, your plan should typically make a decision within 72 hours — or 24 hours if your doctor asks for an expedited decision because your health could be in danger if you’re delayed.

If the request is denied, your plan must instruct you in writing on how to file an appeal.

In all, Medicare has five levels to [its appeals process](https://www.medicare.gov/medicare-prescription-drug-coverage-appeals "medicare drug coverage appeals"), which can culminate in a federal district court review:
...
**5\. Federal court review** if the dollar amount of your case is at least $1,840 in 2024.

ARTICLE CONTINUES AFTER ADVERTISEMENT

### How can I find which plans restrict my drugs?

Before you [choose a Part D plan](https://www.aarp.org/health/medicare-qa-tool/choosing-best-drug-plan-for-me/ "choosing medicare drug plan") for the year, find out whether it has any restrictions on your drugs. Because each plan decides which drugs it will restrict, some drugs may be automatically covered while others may require prior authorization. You can get a list of the plan’s drugs requiring prior authorization, step therapy or quantity limits within the insurer’s plan documents, which are usually posted on its website.

You can also see if the plan has any restrictions on your drugs when comparing [Part D plans in Medicare’s Plan Finder](https://www.aarp.org/health/medicare-insurance/info-2022/part-d-enrollment.html "medicare part d enrollment"). After typing in your ZIP code and identifying Part D plans, add your drugs and preferred pharmacies. You may find that your drugs and pharmacies are already listed if you log in to your [online Medicare account](https://www.aarp.org/health/medicare-qa-tool/medicare-online-account/ "medicare online") before accessing the Plan Finder.

In the Plan Finder, you’ll see a list of plans available in your area with an estimate of your medications’ yearly drug and premium costs. In each plan, under **Drugs,** click on **View drugs & their costs** and scroll below **Estimated total monthly drug cost**. Then click **\+ View more drug coverage**.
...
If your current plan has granted you an exception to use your drug and you’re considering switching to another plan during [open enrollment](https://www.aarp.org/health/medicare-insurance/info-2022/open-enrollment.html "medicare open enrollment"), find out if the other plan places restrictions on the same drug.

If you’re already taking a medication, you have the right to a 30-day refill within the first 90 days of enrolling in a new plan regardless of whether the plan places restrictions on the drug or doesn’t cover it at all. This grace period, also called a “transition refill,” gives you time to work with your doctor to change to an alternative drug or request an exception.

[Return to Medicare Q&A main page](https://www.aarp.org/health/medicare-qa-tool/ "Medicare Q&A Tool")

[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions/#comments_widget_id)
...
[Which path you take will determine how you get your medical care — and how much it costs](https://www.aarp.org/health/medicare-insurance/info-2020/original-medicare-vs-advantage.html)
     ...
     [![Image 275: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 276: three prescription capsules stamped with a dollar sign from left to right the dollar sign increases in size to show rising drug prices](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/medicare-part-d-restrictions/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/rx-drug-price-watch2.coreimg.50.932.jpeg/content/dam/aarp/health/drugs_supplements/2024/01/1140-rx-price-hike-capsules.jpg)](https://www.aarp.org/politics-society/advocacy/info-2024/rx-drug-price-watch.html "10 Prescription Drugs With Excessive Price Hikes")

[10 Prescription Drugs With Excessive Price Hikes](https://www.aarp.org/politics-society/advocacy/info-2024/rx-drug-price-watch.html)

[AARP report finds hundreds of common medications outpace inflation](https://www.aarp.org/politics-society/advocacy/info-2024/rx-drug-price-watch.html)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 277: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 278](https://www.aarp.org/health/medicare-qa-tool/medicare-part-d-restrictions/)
