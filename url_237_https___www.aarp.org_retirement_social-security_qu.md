Title: Do SSI Benefits Vary State To State?

URL Source: https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state/
...
[Skip to content](https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state/#)

[](https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state/#)[](https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state/#)
...
[Back](https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state/#) [Cancel](https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state/#)
...
[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/cambia-pago-por-discapacidad-si-me-mudo-de-estado/)

Published June 11, 2021

/ Updated December 31, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state.html&related=CreateTheGood&text=Will%20my%20Social%20Security%20disability%20benefits%20change%20if%20I%20move%20to%20another%20state?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state.html&title=Will%20my%20Social%20Security%20disability%20benefits%20change%20if%20I%20move%20to%20another%20state?)

[Social Security Disability Insurance](https://www.aarp.org/retirement/social-security/questions-answers/apply-for-ss-disability/ "SSDI") (SSDI) benefits do not change if you move to another state. Like Social Security retirement benefits, SSDI payments are based on your average lifetime earnings and are not affected by where you live.

However, if you receive [Supplemental Security Income](https://www.aarp.org/retirement/social-security/questions-answers/what-is-ssi/ "what is SSI") (SSI), a benefit program that is administered by the Social Security Administration (SSA) but not funded by Social Security taxes, an interstate move could change your monthly payments. That's because most states supplement federal SSI payments from their own funds, in varying degrees.

Members only

                     

[SSI pays benefits](https://www.aarp.org/retirement/social-security/questions-answers/ssi-eligible/ "SSI eligibility") to disabled, blind and older people with very low incomes and limited financial assets. The maximum federal SSI benefit changes annually; in 2025, it's $967 for an individual or $1,450 for a couple. Forty-four states — all but Arizona, Arkansas, Mississippi, North Dakota, Tennessee and West Virginia — offer additional funds to some residents receiving SSI, as does the District of Columbia.
...
In 11 of the 44 states that offer SSI supplements (California, Delaware, Hawaii, Iowa, Michigan, Montana, Nevada, New Jersey, Pennsylvania, Rhode Island and Vermont) and in the District of Columbia, Social Security administers some or all of the additional payments. In these locales, an application for SSI is also an application for the state payment. The remaining 33 states administer their own SSI supplements, and you need to apply to the state separately for the extra payment.

To find out more about states’ programs and benefit amounts, call Social Security at 800-772-1213 or contact the state's department of human services or [Medicaid agency](https://www.medicaid.gov/about-us/contact-us/contact-your-state-questions/index.html "Medicaid state representatives").
...
If you are receiving SSDI or another Social Security benefit [in addition to SSI](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/ "can you get both SSI and SSDI"), you can [report a change of address](https://www.aarp.org/retirement/social-security/questions-answers/moving-change-my-address-with-ssa/ "report a change of address") by logging into your [My Social Security account](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/ "what is My Social Security") online. However, this option is not available if you are getting SSI alone or do not have a U.S. mailing address. (SSI recipients can check the address they have on file with Social Security online but not change it.) You'll need to call the SSA at 800-772-1213 or contact your [local Social Security office](https://secure.ssa.gov/ICON/main.jsp "contact your local Social Security office") to register the new address.

#### Keep in mind

*   While the amount of your SSDI benefit does not change state to state, whether you pay income taxes on it could: Nine states [tax Social Security payments](https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits/ "tax Social Security payments") for at least some recipients. (That doesn't include SSI, which is not taxed anywhere.) Contact your [state tax agency](https://www.taxadmin.org/state-tax-agencies "state tax agencies") for details.
...
*   Among U.S. territories, SSI is available only in the Northern Mariana Islands. Residents of Puerto Rico, the U.S. Virgin Islands and Guam who are older, blind or have a disability may receive benefits under a separate social-welfare program that pays lower amounts than SSI. American Samoa is not covered by such a federal program.

[%{postComment}%](https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state/#comments_widget_id)
...
[Can I qualify for Social Security Disability Insurance and Medicaid at the same time?](https://www.aarp.org/retirement/social-security/questions-answers/ssdi-medicaid/)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 269: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 270](https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state/)
