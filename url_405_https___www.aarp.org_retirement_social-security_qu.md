Title: Some States Tax Your Social Security Benefits

URL Source: https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits/
...
[Skip to content](https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits/#)

[](https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits/#)[](https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits/#)
...
[Back](https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits/#) [Cancel](https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits/#)
...
[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/cuales-estados-cobran-impuestos/)

Published October 10, 2018

/ Updated June 21, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits.html&related=CreateTheGood&text=Which%20states%20tax%20Social%20Security%20benefits?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits.html&title=Which%20states%20tax%20Social%20Security%20benefits?)

A portion of Social Security retirement, [disability](https://www.aarp.org/retirement/social-security/questions-answers/disability-benefits/ "disability benefits") and other benefits are [subject to federal income tax](https://www.aarp.org/retirement/social-security/questions-answers/how-is-ss-taxed/ "benefits subject to federal taxes") if your overall income exceeds a cap the U.S. government sets. Nine states also tax some or all of their residents’ Social Security benefits: Colorado, Connecticut, Minnesota, Montana, New Mexico, Rhode Island, Utah, Vermont and West Virginia.

[Kansas](https://www.aarp.org/retirement/social-security/info-2024/kansas-west-virginia-not-taxing-benefits.html "kansas ends tax on social security benefits"), Missouri and Nebraska no longer tax benefits, effective this year (that is, for 2024 tax returns due by April 2025). West Virginia is [phasing out the tax](https://blog.aarp.org/fighting-for-you/west-virginia-social-security-tax-repeal "west virginia ending tax on social security benefits") over the next two years.
...
![Image 263: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg)      ![Image 264: Image Alt Attribute](https://cdn.aarp.net/content/dam/experience-fragments/uxdia-folder-structure/en/features/membership/inline-membership-promo/default/master5/_jcr_content/root/responsivegrid/container_copy/container/articleimage.coreimg.75.1140.png/content/dam/uxdia/membership-card-d-and-t.png) 
...
Connecticut’s income-tax rate ranges from 3 percent to 6.99 percent. For more information, contact the [Connecticut Department of Revenue Services](https://portal.ct.gov/drs "connecticut tax information").
...
Residents may use an [alternative method](https://www.revenue.state.mn.us/social-security-benefit-subtraction "minnesota social security subtraction") to determine taxes they owe on Social Security income, based on how the deduction worked for all beneficiaries before 2023, when lawmakers [changed the state’s policy](https://www.aarp.org/retirement/social-security/info-2023/cut-taxes-social-security-benefits.html "states that cut tax on social security benefits"). However, very few taxpayers benefit from using the alternative method, according to a [March 2024 report](https://www.house.mn.gov/hrd/pubs/ss/ssmnsocsec.pdf "minnesota tax on social security twenty twenty four") by the Minnesota House Research Department.

Minnesota taxes income at rates ranging from 5.35 percent to 9.85 percent. For more information, contact the [Minnesota Department of Revenue](https://www.revenue.state.mn.us/ "minnesota tax information").

### **Montana**

Like the federal government, Montana does not tax Social Security for people with overall incomes of less than $25,000 for a single filer and $32,000 for a couple filing jointly. Residents who make more are liable for tax on their benefits, but the state uses a different method than the feds to determine the taxable amount. The [state tax form](https://mtrevenue.gov/publications/montana-individual-income-tax-return-form-2/) includes a worksheet for calculating the difference.

Montana’s income-tax rates range from 1 percent to 6.75 percent. The top rate will drop to 5.9 percent in the 2024 tax year. For more information, contact the [Montana Department of Revenue](https://mtrevenue.gov/taxes/ "montana tax information").
...
New Mexico taxes income at rates from 1.7 percent to 5.9 percent. For more information contact the [New Mexico Taxation & Revenue Department](https://www.tax.newmexico.gov/ "new mexico tax information").

### Rhode Island  

The state does not tax benefits for people who have reached [full retirement age](https://www.aarp.org/retirement/social-security/questions-answers/social-security-full-retirement-age/ "full retirement age for social security") as defined by the Social Security Administration (between 66 and 67, depending on year of birth) and have an AGI below $126,250 for a couple filing jointly or $101,000 for a single filer or head of household. If you have not reached full retirement age, or have and your income exceeds those thresholds, your benefits are taxable.

Rhode Island taxes income at rates ranging from 3.75 percent to 5.99 percent. For more information, contact the Rhode Island Department of Revenue’s [Division of Taxation](http://www.tax.ri.gov/ "rhode island tax information").

### Utah

Utah uses the federal formula to calculate how much Social Security income is taxable at the state tax rate, which is 4.55 percent, but the state offers a full or partial credit on those taxable benefits.

Married couples filing jointly and heads of households reporting 2023 income of $75,000 or less, and singles making $45,000 or less, qualify for a full tax credit on their benefit income. Those earning more can still get a partial break on their benefits, with the tax credit reduced by 25 cents for each dollar above the income thresholds above.

For more information, contact the [Utah State Tax Commission](https://tax.utah.gov/ "utah tax information").
...
For single filers earning $60,000 or more and couples making $75,000 or more, benefits are fully taxed at the state rate, which ranges from 3.35 percent to 8.75 percent. For more information, contact the Vermont Agency of Administration’s [Department of Taxes](https://tax.vermont.gov/ "vermont tax information").

### West Virginia

For the 2024 tax year, West Virginians receiving Social Security can subtract 35 percent of their benefits from their state taxable income. For 2025, the deduction is 65 percent, and from 2026 on, Social Security income is fully deductible.

West Virginia’s income-tax rates range from 2.36 percent to 5.12 percent. For more information, contact the [West Virginia State Tax Department](https://tax.wv.gov/Pages/default.aspx "west virginia tax information").

#### Keep in mind

None of the above applies to [Supplemental Security Income](https://www.aarp.org/retirement/social-security/questions-answers/what-is-ssi/ "SSI"), a monthly benefit for people who are 65-plus or have a disability or vision loss and have [very low incomes](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/) and [limited assets](https://www.aarp.org/retirement/social-security/questions-answers/how-do-financial-resources-impact-ssi-eligibility/). SSI, which is administered by the Social Security Administration, is not subject to income taxes.

[%{postComment}%](https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits/#comments_widget_id)
...
[Navigating Social Security](https://www.aarp.org/retirement/social-security/questions-answers/taxes-withheld-ss/)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 281: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 282](https://www.aarp.org/retirement/social-security/questions-answers/which-states-do-not-tax-social-security-benefits/)
