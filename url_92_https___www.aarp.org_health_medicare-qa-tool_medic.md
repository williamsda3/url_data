Title: I receive health insurance from my domestic partner’s employer. Can I delay Part B enrollment after I become eligible for Medicare, without risking late penalties?

URL Source: https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b/
...
[Skip to content](https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b/#)

[](https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b/#)[](https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b/#)

[AARP Medicare Question and Answer Tool](https://www.aarp.org/health/medicare-qa-tool/)

I receive health insurance from my domestic partner’s employer. Can I delay Part B enrollment after I become eligible for Medicare, without risking late penalties?
===================================================================================================================================================================
...
[En español](http://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/retrasar-cobertura-inscripcion-medicare-parte-b)

Published January 01, 2014

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b.html&related=CreateTheGood&text=)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b.html&title=)

Probably not.

Many workplace health plans do offer coverage for an employee’s domestic partner. And some domestic partners assume that, like legally married people, they don’t need to enroll in [Medicare Part B](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-part-b/) when they turn 65, as long as they remain on their partner’s plan.

Members only

                     

That is not so. Medicare does not offer domestic partners the same benefit rights as legal spouses.

Legal spouses’ rights include a [special enrollment period,](https://www.aarp.org/health/medicare-qa-tool/why-do-some-enroll-in-part-b-after-65/) or SEP, for Medicare Part B, which primarily covers doctors’ services and outpatient care. Legal spouses who become eligible for Medicare can delay signing up, without risking a late penalty, if they have insurance through their mate’s job. When your spouse’s employment ends and you lose that coverage, you have an eight-month grace period to enroll in Part B with no penalty.

If domestic partners in the same situation delay signing up, they are not entitled to that special enrollment period and will pay penalties for Part B, in the form of permanently higher premiums.

Medicare officials will measure the late period from when you first became eligible. The longer that gap, the bigger the penalty.

Domestic partners might qualify for a special enrollment period and avoid late charges only for these two narrow exceptions:

**Common-law marriage.** If you and your partner live in a state that recognizes  [common-law marriages](https://www.aarp.org/retirement/social-security/questions-answers/does-social-security-recognize-common-law-marriages/) and your relationship meets the legal definition of common-law marriage in that state, Medicare will consider you spouses and apply the spousal rules.

**Disability.** People who receive [Social Security Disability Insurance](https://www.aarp.org/retirement/social-security/questions-answers/apply-for-ss-disability/) (SSDI) can qualify for Medicare before age 65. Domestic partners with a disability may be allowed a special enrollment period if they meet all these conditions:
...
[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b/#comments_widget_id)
...
More on Medicare
     ...
     [![Image 263: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 264: Medicare Card](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/medicare-domestic-partner-part-b/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/qualify-for-medicare-at-age-631.coreimg.50.932.jpeg/content/dam/aarp/health/medicare_insurance/2019/06/1140-medicare-card.jpg)](https://www.aarp.org/health/medicare-qa-tool/qualify-for-medicare-at-age-63/ "Is my spouse allowed to enroll in Medicare at age 63?
")

[Is my spouse allowed to enroll in Medicare at age 63?](https://www.aarp.org/health/medicare-qa-tool/qualify-for-medicare-at-age-63/)

[65 is the youngest age that healthy people can qualify](https://www.aarp.org/health/medicare-qa-tool/qualify-for-medicare-at-age-63/)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 265: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 266](https://www.aarp.org/health/medicare-qa-tool/medicare-domestic-partner-part-b/)
