Title: Does Receiving A Pension Affect Social Security?

URL Source: https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security/
...
[Skip to content](https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security/#)

[](https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security/#)[](https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security/#)
...
[Back](https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security/#) [Cancel](https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security/#)
...
[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/pension-reduce-mis-beneficios/)

Published October 10, 2018

/ Updated November 17, 2023

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security.html&related=CreateTheGood&text=Does%20a%20pension%20reduce%20my%20Social%20Security%20benefits?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security.html&title=Does%20a%20pension%20reduce%20my%20Social%20Security%20benefits?)

In the vast majority of cases, no. If the pension is from an employer that [withheld FICA taxes](https://www.aarp.org/retirement/social-security/questions-answers/ss-fica/) from your paychecks, as almost all do, it won’t affect your Social Security retirement benefits.

If there was no such withholding, you may be subject to the [Windfall Elimination Provision](https://www.aarp.org/retirement/social-security/questions-answers/what-is-the-windfall-elimination-provision/) (WEP), which covers people who earned pensions from such "non-covered" jobs but also qualify for Social Security due to other work.

Members only

                     

For these workers, Social Security uses a modified formula to calculate the [full-retirement-age](https://www.aarp.org/retirement/social-security/questions-answers/social-security-full-retirement-age/) benefit amount. This formula results in a lower Social Security benefit but never reduces the benefit to $0.
...
A similar rule, the [Government Pension Offset](https://www.aarp.org/retirement/social-security/questions-answers/pension-social-security-spouse/) (GPO), affects spouses, widows and widowers who collect [spousal](https://www.aarp.org/retirement/social-security/questions-answers/spouse-social-security/) or [survivor benefits](https://www.aarp.org/retirement/social-security/questions-answers/how-do-survivor-benefits-work/) from Social Security and also receive pensions from federal, state or local government jobs that did not withhold Social Security taxes. Their benefits are reduced by two-thirds of their government pension — and can be eliminated entirely if that two-thirds exceeds the Social Security payment.
...
*   Pension income does not count against the [Social Security earnings limit](https://www.aarp.org/retirement/social-security/questions-answers/working-while-collecting-social-security/), regardless of the pension's source.

[%{postComment}%](https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security/#comments_widget_id)
...
[Can Social Security tell me if a former employer owes me pension benefits?](https://www.aarp.org/retirement/social-security/questions-answers/ssa-former-employer-pension-benefits/)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 261: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 262](https://www.aarp.org/retirement/social-security/questions-answers/do-pensions-reduce-social-security/)
