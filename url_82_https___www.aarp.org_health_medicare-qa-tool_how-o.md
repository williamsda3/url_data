Title: Can I change Medicare Part D prescription drug plans at any time?

URL Source: https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/

Published Time: 2022-05-18T04:00:00+0000

Markdown Content:
Can I Change Medicare Part D Plans At Any Time?
===============
                                                     

[Skip to content](https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/#)

[](https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/#)[](https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/#)
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/frecuencia-cambios-cobertura-medicamentos-recetados/)

Published May 18, 2022

/ Updated May 01, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan.html&related=CreateTheGood&text=Can%20I%20change%20Medicare%20Part%20D%20prescription%20drug%20plans%20at%20any%20time?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan.html&title=Can%20I%20change%20Medicare%20Part%20D%20prescription%20drug%20plans%20at%20any%20time?)
...
You can get prescription drug coverage either by enrolling in a [stand-alone Medicare Part D plan](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/ "enrolling in part d") or from a [Medicare Advantage](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-advantage/ "what is medicare advantage") plan that combines medical and drug coverage. Private insurance companies that Medicare regulates offer both types of plans.
...
Even if you’re happy with your Part D or Medicare Advantage plan, comparing your options during open enrollment every year is a good idea because these plans can change coverage and costs from one year to the next. Type your [zip code, drugs and dosages](https://www.aarp.org/health/medicare-insurance/info-2022/part-d-enrollment.html "part d enrollment") into the [Medicare Plan Finder](https://www.medicare.gov/plan-compare "medicare plan compare") to see costs for every plan available in your area, including premiums and copayments for your medications.

**Jan. 1 to March 31, Medicare Advantage open enrollment.** If you have Medicare Advantage prescription drug coverage, you get an extra chance to [switch to another MA plan](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/ "can you switch medicare advantage plans") or leave MA altogether and opt for original Medicare and a Part D plan. You can make only one change during this enrollment period.

Be aware: Most people who enroll in [original Medicare](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/ "what is original medicare") buy a [Medigap supplement policy](https://www.aarp.org/health/medicare-qa-tool/what-is-medigap-insurance/ "what is medigap insurance") to cover out-of-pocket expenses. If you leave Medicare Advantage for original Medicare, you risk losing your guaranteed [right to buy a Medigap policy](https://www.aarp.org/health/health-insurance/info-2021/avoid-medigap-mistakes.html "avoid these medigap mistakes") if more than six months have passed since you signed up for Medicare Part B. Check with your [State Health Insurance Assistance Program](https://www.shiphelp.org/ "state health insurance programs") (SHIP) to find out whether an insurer could reject you or charge you more for preexisting conditions.
...
You may qualify for a [special enrollment period](https://www.medicare.gov/basics/get-started-with-medicare/get-more-coverage/joining-a-plan/special-enrollment-periods "medicare special enrollment periods") to change your Part D plan in certain situations at other times of the year.

**If you receive financial assistance** from the [Part D Extra Help program](https://www.aarp.org/health/medicare-qa-tool/financial-help-for-medication-costs/ "extra help for medication costs"), you can change Part D plans as often as once a quarter during the first three quarters of the year. Extra Help assists people with low incomes and assets pay Part D premiums and copayments.
...
**If a [five-star-rated Part D](https://www.aarp.org/health/medicare-qa-tool/what-are-star-ratings/ "what are medicare star ratings") plan** or Medicare Advantage plan covers your area, you can switch to it once at any time of the year, except during the first week in December. Coverage begins the first day of the month after the plan receives your enrollment request.

ARTICLE CONTINUES AFTER ADVERTISEMENT

#### Keep in mind

Unless you have similar prescription drug coverage from an employer, retiree plan, Tricare or other source considered “creditable coverage,” signing up for Medicare Part D is important even if [you don’t take many medications](https://www.aarp.org/health/medicare-qa-tool/i-take-few-meds-do-i-need-a-part-d-plan/). Otherwise, you could end up with a lifetime [late enrollment penalty](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/ "medicare late enrollment penalty") when you eventually sign up.
...
[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/#comments_widget_id)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 281: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 282](https://www.aarp.org/health/medicare-qa-tool/how-often-can-i-change-my-part-d-plan/)
