...
URL Source: https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/

Published Time: 2022-12-09T05:00:00+0000
...
[Skip to content](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/#aarp-u-end-of-header)
...
[](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/#)[](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/#)
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/que-es-medicare-original/)

Published December 09, 2022

/ Updated October 17, 2023

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare.html&related=CreateTheGood&text=What%20is%20original%20Medicare?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare.html&title=What%20is%20original%20Medicare?)

Originally conceived as a big step toward ensuring health care coverage and financial stability for our nation’s older population, Medicare is a federal insurance program that provides [guaranteed health insurance](https://www.aarp.org/health/medicare-insurance/info-2020/what-is-medicare.html "what is medicare") for people age 65 and older and for younger people who [qualify because of a disability](https://www.aarp.org/retirement/social-security/info-2022/medicare-for-ssdi-beneficiaries.html "medicare for disability beneficiaries"). More commonly known as original Medicare or traditional Medicare, the program refers to the first two parts of Medicare, Part A and Part B, included in a bill that President Lyndon B. Johnson signed into law in 1965.

*   [**Part A**](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-part-a/ "what is medicare part a") helps pay for [inpatient stays in hospitals](https://www.aarp.org/health/medicare-qa-tool/what-hospital-costs-are-covered-under-part-a/ "what is covered under part a") and skilled nursing facilities, some home care and [end-of-life hospice care](https://www.aarp.org/health/medicare-qa-tool/does-medicare-cover-hospice-care/ "does medicare cover hospice").

*   **[Part B](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-part-b/ "what is medicare part b")** covers doctors’ services, diagnostic screenings, lab tests, outpatient care, [preventive services](https://www.aarp.org/health/medicare-qa-tool/is-wellness-care-covered-by-part-a-or-b/ "preventative services covered by medicare"), plus some [medical equipment](https://www.aarp.org/health/medicare-qa-tool/does-medicare-cover-medical-supplies/ "medicare and medical equipment") and transportation.

**Medicare eligibility** isn’t based on your income or assets, and you can’t be denied coverage or charged more because of existing medical conditions. With original Medicare, you can use any doctor or other provider in the United States that [participates in the program](https://www.aarp.org/health/medicare-qa-tool/define-term-medicare-assignment/ "what is medicare assignment"). More than 95 percent of surgeons, as well as some 90 percent of nonpediatric physicians, 80 percent of most other specialists and 60 percent of psychiatrists, are accepting new Medicare patients.

[**Other parts of Medicare**](https://www.aarp.org/health/medicare-insurance/info-01-2011/understanding_medicare_the_plans.html "medicare's parts") were introduced later and are not considered original Medicare.
...
**Premiums.** Most people don’t have to pay [premiums for Part A](https://www.aarp.org/health/medicare-qa-tool/what-is-the-premium-for-part-a/ "medicare part a premiums") because they or their spouse had [Medicare taxes withheld](https://www.aarp.org/health/medicare-qa-tool/medicare-payroll-taxes/ "medicare payroll taxes") from their paychecks for 40 quarters, 10 years of work that don’t have to be continuous. Almost everyone pays a [premium for Part B](https://www.aarp.org/health/medicare-qa-tool/what-are-costs-for-part-b/ "medicare part b costs"), typically $164.90 a month in 2023 and $174.70 in 2024; [high earners can expect to pay more](https://www.aarp.org/health/medicare-insurance/info-2022/how-to-lower-medicare-premiums.html "income and medicare premiums").
...
If you don’t have other drug coverage considered to be at least as good as Medicare’s, called “creditable coverage,” you [must sign up for Part D](https://www.aarp.org/health/medicare-qa-tool/i-take-few-meds-do-i-need-a-part-d-plan/ "do you need part d") or you could face a [late enrollment penalty](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/ "medicare late enrollment penalty") later. Drug coverage from an employer, a former employer, Tricare for career military members and retirees, or the Department of Veterans Affairs can be considered creditable coverage.

You can [buy a Part D policy](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/ "enrolling in medicare part d") when you first enroll in Medicare or within two months of losing other prescription coverage. You also have an option to sign up or switch policies every year during [open enrollment](https://www.aarp.org/health/medicare-insurance/info-2022/open-enrollment.html "medicare open enrollment"), which runs from Oct. 15 to Dec. 7. Coverage will start Jan. 1.
...
**Medigap insurance.** Many people with original Medicare buy a [Medicare supplement policy](https://www.aarp.org/health/medicare-qa-tool/what-is-medigap-insurance/ "what is medigap"), also known as Medigap, to help pay Medicare’s deductibles and copayments.
...
You have the [option to get Medicare](https://www.aarp.org/health/medicare-insurance/info-2020/original-medicare-vs-advantage.html "medicare vs advantage") coverage either from federally run original Medicare or through a [private Medicare Advantage plan](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-advantage/ "what is medicare advantage"). The choices have some key differences.
...
**With a Medicare Advantage plan,** your coverage comes from a private insurer even though you sign up for Part A and B through the federal government. You still must pay the Part B premium. These plans must provide at least as much coverage as original Medicare, but they can have [different out-of-pocket costs](https://www.aarp.org/health/medicare-insurance/info-2018/out-of-pocket-prescription-costs.html "out of pocket costs").

Advantage plans may offer additional coverage [not part of original Medicare](https://www.aarp.org/health/medicare-insurance/info-2018/services-not-covered.html "services not covered by medicare"), such as [dental,](https://www.aarp.org/health/medicare-qa-tool/does-medicare-cover-dental-care/ "does medicare cover dental") [hearing,](https://www.aarp.org/health/medicare-qa-tool/does-medicare-cover-hearing-tests/ "does medicare cover hearing tests") prescriptions and [vision](https://www.aarp.org/health/medicare-qa-tool/does-medicare-cover-vision-care/ "does medicare cover vision"). Because most Medicare Advantage plans have a provider network, doctors you have already who are not part of the network could cost you more or not be covered at all. You may need permission from the plan’s officials, called prior authorization, to see a specialist.

You can choose from [several Medicare Advantage](https://www.aarp.org/health/medicare-qa-tool/finding-the-best-plan-for-me/ "finding best advantage plan") plans available in your area and can enroll in Medicare Advantage during your initial enrollment period or during open enrollment each year.
...
**Some register themselves.** [You can sign up](https://www.aarp.org/health/medicare-qa-tool/turning-65-when-to-apply-for-medicare/ "when to apply for medicare") during your seven-month [initial enrollment period,](https://www.aarp.org/health/medicare-insurance/info-2022/initial-enrollment-period.html "medicare initial enrollment") which starts three months before the month you turn 65 and ends three months after your birthday month. So if your birthday is May 15, you can sign up as early as Feb. 1 or as late as Aug. 31.

**Some can sign up later.** If you choose to enroll after age 65, you may have to pay a [late enrollment penalty](https://www.aarp.org/health/medicare-qa-tool/how-much-is-the-part-b-late-enrollment-penalty/ "medicare late enrollment penalty") unless you or your spouse is still working and you have health [insurance from a current employer](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/ "medicare if you're still working"). In that case, you may be able to [delay signing up](https://www.aarp.org/health/medicare-insurance/info-2022/special-enrollment-period.html "medicare special enrollment period") for Part A and Part B until eight months after you or your spouse leaves the job and you lose that coverage.

[Return to Medicare Q&A main page](https://www.aarp.org/health/medicare-qa-tool/ "medicare question and answer tool")

[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/#comments_widget_id)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 281: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 282](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/)
