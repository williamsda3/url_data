Title: What is the 'Substantial Gainful Activity' Income Limit?

URL Source: https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/

Markdown Content:
What is the 'Substantial Gainful Activity' Income Limit?
=============== 

[Skip to content](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/#)

[](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/#)[](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/#)
...
[Back](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/#) [Cancel](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/#)
...
[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/que-es-actividad-sustancial-y-lucrativa/)

Published July 02, 2021

/ Updated December 31, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity.html&related=CreateTheGood&text=What%20is%20substantial%20gainful%20activity?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity.html&title=What%20is%20substantial%20gainful%20activity?)

"Gainful work activity” is [Social Security's term](https://www.aarp.org/retirement/social-security/info-2021/social-security-glossary-of-terms.html) for work you do for pay or profit. Employment that provides income above a certain level is considered “substantial gainful activity,” or SGA, and renders you ineligible for [Social Security Disability Insurance](https://www.aarp.org/retirement/social-security/questions-answers/apply-for-ss-disability/) (SSDI).

The SGA limit is adjusted annually to reflect changes in national average wages. In 2025, it's $1,620 a month ($2,700 for blind people). If you make more than that, your application for SSDI benefits will be denied. If you already are receiving benefits, you'll lose them in most circumstances if your income rises above the cap.

Members only

                     

The strict limits grow out of the core purpose of Social Security disability benefits: to provide financial support to people temporarily or permanently unable to work because of [a medical condition](https://www.aarp.org/retirement/social-security/questions-answers/medical-conditions/). You are allowed to [do some paying work](https://www.aarp.org/retirement/social-security/questions-answers/part-time-work-on-disability/) while drawing disability benefits. But if you are able to do “substantial” work, the reasoning goes, you do not have a disability.

The substantial gainful activity test applies to all applicants for and ongoing recipients of SSDI. For [Supplemental Security Income](https://www.aarp.org/retirement/social-security/questions-answers/what-is-ssi/) (SSI), the other Social Security-administered benefit for people with disabilities, it comes into play only at the application stage.

That means you can be denied SSI if your work income exceeds the SGA threshold when you file for benefits, but that limit does not apply once you are getting SSI. However, you will be subject to separate, SSI-specific [limits on income](https://www.aarp.org/retirement/social-security/questions-answers/ssi-eligible/). People who get SSI on the basis of blindness are exempt from income limits, and the substantial gainful activity limit does not apply to them at any point.

For wage earners, SGA is measured in gross pay. If you are self-employed, Social Security applies net income to the cap but may weigh other measures of work activity to determine if your gainful activity is substantial. For example, it might consider the number of hours you put into managing your business or whether your professional activity is comparable, in terms of time, skills and duties, to that of people without disabilities who are doing the same type of work.
...
The limits on substantial gainful activity have some exceptions, particularly for beneficiaries trying to [return to the labor force](https://www.aarp.org/retirement/social-security/questions-answers/what-is-ticket-to-work-program/).

The Social Security Administration allows people on SSDI to [engage in trial work](https://www.aarp.org/retirement/social-security/questions-answers/trial-work-period/) for up to nine months. In these months, which don't need to be consecutive and can be spread out over five years, you can receive your full benefit regardless of your income.
...
In addition, disability beneficiaries may reduce their income for SGA purposes by [deducting some expenses](https://www.aarp.org/retirement/social-security/questions-answers/what-are-impairment-related-work-expenses/) for products and services that enable them to work, such as paratransit, assistive technology, medication or a service animal. If deductible expenses bring your monthly wages in 2025 under $1,620 (or $2,700 if you are blind), you are not be considered to be exceeding the cap.

You can find more information on the work rules and exceptions for SSI and SSDI beneficiaries in the Social Security pamphlet [_Working While Disabled: How We Can Help._](https://www.ssa.gov/pubs/EN-05-10095.pdf)

#### **Keep in mind**

*   Even if you are making less than the SGA cap, Social Security can end your benefits if it determines, via [periodic medical reviews](https://www.aarp.org/retirement/social-security/questions-answers/what-is-a-social-security-disability-review/) or other evidence, that you are _able_ to return to substantial work because of changes in your condition or capabilities.
*   Disabled beneficiaries are obligated to report changes in their job status or income to Social Security. You can use your [My Social Security account](https://www.aarp.org/retirement/social-security/questions-answers/what-is-my-social-security/) to report wages online. If you can don't have an account, you can report changes by phone at 800-772-1213 or provide the information directly to your [local Social Security office](https://secure.ssa.gov/ICON/main.jsp), in person or by mail. 

[%{postComment}%](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/#comments_widget_id)
...
[What is a Social Security disability review?](https://www.aarp.org/retirement/social-security/questions-answers/what-is-a-social-security-disability-review/)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 269: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 270](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/)
