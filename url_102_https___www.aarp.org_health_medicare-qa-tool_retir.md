Title: Federal Retiree Insurance and Medicare enrollment

URL Source: https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/

Published Time: 2023-02-14T05:00:00+0000

Markdown Content:
Federal Retiree Insurance and Medicare Enrollment
=============== 

[Skip to content](https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/#)

[](https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/#)[](https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/#)

[AARP Medicare Question and Answer Tool](https://www.aarp.org/health/medicare-qa-tool/)

I have federal retiree health insurance. Do I have to sign up for Medicare?
===========================================================================
...
[En español](http://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/jubilacion-gobierno-federal-necesito-medicare-parte-b)

Published February 14, 2023

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb.html&related=CreateTheGood&text=I%20have%20federal%20retiree%20health%20insurance.%20Do%20I%20have%20to%20sign%20up%20for%20Medicare?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb.html&title=I%20have%20federal%20retiree%20health%20insurance.%20Do%20I%20have%20to%20sign%20up%20for%20Medicare?)
...
This isn’t the case for other types of [retiree health insurance](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/ "retiree health insurance and medicare"). Typically, health insurance coverage from a former employer, [rather than a current employer](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/ "medicare if still working"), becomes secondary to Medicare when you turn 65.
...
**Enrolling in Part A.** If you aren’t required to [pay a premium for Part A](https://www.aarp.org/health/medicare-qa-tool/what-is-the-premium-for-part-a/ "what are the premiums for medicare part a"), you may want to sign up for Medicare at age 65 or when you leave your federal job if you work beyond 65.

The federal [Office of Personnel Management](https://www.opm.gov/healthcare-insurance/healthcare/medicare/medicare-vs-fehb-enrollment "enrolling in medicare or federal retiree insurance") encourages federal retirees to enroll in Part A if their premiums are free. Federal employees in January 1984 began transitioning into the Social Security system from the old Civil Service Retirement System and paying Social Security and Medicare taxes.

But if you’re working for a private-sector employer after retirement from your federal job and have a high-deductible health plan that allows you set aside pretax money in a [health savings account](https://www.aarp.org/health/medicare-qa-tool/health-savings-account/ "health savings accounts and medicare") (HSA), you won’t be able to contribute to an HSA after enrolling in either part of Medicare.
...
Part B costs [$164.90 a month](https://www.aarp.org/health/medicare-qa-tool/what-are-costs-for-part-b/ "what are the costs for medicare part b") in 2023 for most people. It [costs more](https://www.aarp.org/health/medicare-insurance/info-2022/how-to-lower-medicare-premiums.html "how income affects medicare premiums") if you’re single and your modified adjusted gross income is higher than $97,000, or higher than $194,000 if married and filing jointly.

You can continue to receive full coverage from the FEHB plan after 65, unlike other types of retiree benefits that may not pay unless you enroll in Medicare. But if you decide to get Part B later — if, for example, you think your federal health benefits have become too expensive when compared to Medicare — you could get stuck with a [late enrollment penalty](https://www.aarp.org/health/medicare-qa-tool/how-much-is-the-part-b-late-enrollment-penalty/ "medicare part b late enrollment penalty"). The penalty adds 10 percent of the standard Part B premium for each 12-month period you could have had Part B but chose not to enroll.
...
**Retiree vs. active employee.** While you or your spouse is working for the government, your federal health benefits count as [coverage from a large employer](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/). You don’t have to sign up for Medicare while either one of you is still working and for up to eight months after that employment or coverage ends, whichever comes first.
...
### **How does Medicare work with federal retiree coverage?**
...
Medicare will pay some for products and services that your FEHB plan may not cover, including specific medical equipment and supplies, home health care and orthopedic and prosthetic devices. See the Office of Personnel Management’s [FEHB and Medicare guide](https://www.opm.gov/healthcare-insurance/healthcare/medicare/coordination-of-medicare-and-fehb-benefits/ "medicare and federal retiree insurance guide") for more information about coordinating the two types of coverage.

#### **Keep in mind**

**Prescription drug coverage.** The drug coverage that FEHB plans provide  is “creditable coverage,” which means it’s considered to be at least as good as [Medicare’s Part D drug plan](https://www.aarp.org/health/medicare-insurance/info-2018/part-d-prescription-drugs.html "medicare part d for prescription drugs"). You don’t have to sign up for Part D if you have FEHB drug coverage, whether you’re a current federal employee or a retiree. And you won’t have to pay a late enrollment penalty as long as you sign up for Part D within 63 days of losing that coverage.

However, you may want to look into Part D if you could benefit from the [Extra Help program](https://www.aarp.org/health/medicare-qa-tool/financial-help-for-medication-costs/ "extra help for prescription drug costs"), which helps cover Part D costs for people with low incomes.

_Updated February 14, 2023_

[Return to Medicare Q&A main page](https://www.aarp.org/health/medicare-qa-tool/ "Medicare Q&A Tool")

[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/#comments_widget_id)
...
[You’ll need to plan ahead to pay for some common medical expenses](https://www.aarp.org/health/medicare-insurance/info-2018/services-not-covered.html)
     ...
     [![Image 277: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 278: coins sitting on top of a Medicare card](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/retiring-federal-employee-fehb/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/does-medicare-cover-all-health-care-costs2.coreimg.50.932.jpeg/content/dam/aarp/health/medicare_insurance/2020/06/1140-medicare-costs.jpg)](https://www.aarp.org/health/medicare-qa-tool/does-medicare-cover-all-health-care-costs/ "Does Medicare Cover All the Costs for My Health Care?
")
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 281: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 282](https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/)
