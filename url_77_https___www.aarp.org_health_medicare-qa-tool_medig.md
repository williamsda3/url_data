Title: How are Medigap and Medicare Advantage different?

URL Source: https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage/

Published Time: 2022-06-07T04:00:00+0000
...
[Skip to content](https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage/#aarp-u-end-of-header)
...
[](https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage/#)[](https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage/#)
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/advantage-vs-medigap/)

Published June 07, 2022

/ Updated January 30, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage.html&related=CreateTheGood&text=How%20are%20Medigap%20and%20Medicare%20Advantage%20different?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage.html&title=How%20are%20Medigap%20and%20Medicare%20Advantage%20different?)

Medigap and Medicare Advantage are both coverage options for people with Medicare, but Medigap policies supplement original Medicare, while Medicare Advantage is a private insurance alternative to federally run Medicare. They’re very different, and their unique types of coverage can’t be combined.

Only those enrolled in [original Medicare](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/ "what is original medicare"), which includes [Part A hospitalization](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-part-a/ "hospital services covered by part a") and [Part B doctor and outpatient care](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-part-b/ "what is medicare part b"), can purchase Medigap, also called [Medicare supplement insurance](https://www.aarp.org/health/medicare-qa-tool/what-is-medigap-insurance/ "what is medigap"). People choose to purchase Medigap to pay for some health care costs that Medicare doesn’t cover. While it’s not government run, federal rules standardize Medigap policies, which are sold through private insurers, to cover [out-of-pocket Medicare expenses](https://www.aarp.org/health/medicare-qa-tool/does-medicare-cover-all-health-care-costs/), such as deductibles and copayments.
...
*   20 percent [Part B coinsurance](https://www.aarp.org/health/medicare-qa-tool/what-are-costs-for-part-b/ "costs for medicare part b") for physician visits and other outpatient services.

*   [Part A daily coinsurance](https://www.aarp.org/health/medicare-qa-tool/what-is-the-premium-for-part-a/ "premium for medicare part a") for days 61 to 90 in the hospital for each benefit period; $408 a day in 2024.
...
*   Coinsurance costs for [hospice care.](https://www.aarp.org/health/medicare-qa-tool/does-medicare-cover-hospice-care/ "does medicare cover hospice")

**Some Medigap plans also cover:**

*   [Part A hospital deductible](https://www.aarp.org/health/medicare-qa-tool/what-hospital-costs-are-covered-under-part-a/ "what's covered under medicare part a"): $1,632 per benefit period in 2024.

*   Coinsurance costs for [skilled nursing facilities](https://www.aarp.org/health/medicare-qa-tool/current-long-term-nursing-home-coverage/ "medicare nursing home coverage"): $204 for days 21 through 100 in 2024.

*   [Foreign travel](https://www.aarp.org/health/medicare-qa-tool/does-medicare-cover-me-outside-the-us/ "medicare if outside the US") emergencies.

You can go to any doctor who accepts Medicare — Medigap will fill in the gaps. But Medigap doesn’t cover prescription drugs, so if you have traditional Medicare and want drug coverage, you’ll need to get a stand-alone [Part D prescription drug policy](https://www.aarp.org/health/medicare-insurance/info-2018/part-d-prescription-drugs.html "medicare part d for prescription drugs").
...
You can [buy a Medigap policy](https://www.aarp.org/health/medicare-insurance/info-2017/choosing-right-medigap-plan.html "choosing the right medigap plan") any time you have Medicare Part A and Part B. But Medigap insurers in most states can reject you or charge more [if you have preexisting conditions](https://www.aarp.org/health/medicare-qa-tool/medicare-preexisting-medical-conditions/ "medicare and preexisting conditions") unless you buy a policy [during certain times](https://www.aarp.org/health/medicare-qa-tool/best-time-to-buy-a-medigap-policy/ "when to buy medigap"), such as within six months of enrolling in Medicare Part B if you’re 65 or older. Medigap insurers must also offer you a [policy regardless of preexisting conditions](https://www.aarp.org/health/health-insurance/info-2021/avoid-medigap-mistakes.html "avoid these medigap mistakes") in other situations, such as if you were enrolled in a Medicare Advantage plan but moved outside of the plan’s service area.

Some states have extra protections. Contact your [State Health Insurance Assistance Program](https://www.shiphelp.org/ "state health insurance program") (SHIP) to find out more about your state’s rules. When exploring your options, you can find out more about Medigap plans in your area from the [Medicare Plan Finder](https://www.aarp.org/health/medicare-insurance/info-2022/buying-medigap-policy.html "buying a medigap policy") or from your [state insurance department](https://content.naic.org/state-insurance-departments "state insurance departments").
...
[Medicare Advantage](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-advantage/ "what is medicare advantage"), also known as Medicare Part C, is an all-in-one [alternative to original Medicare](https://www.aarp.org/health/medicare-insurance/info-2020/original-medicare-vs-advantage.html "medicare vs medicare advantage"). Medicare Advantage plans are offered by private companies that contract with Medicare. These plans bundle Part A hospital coverage, Part B doctor and outpatient services, and usually Part D prescription drug coverage into one package.

If you decide to get coverage through a Medicare Advantage plan, you’ll still have to enroll in Medicare Part A and Part B, including paying the premiums. [Part A is premium-free](https://www.aarp.org/health/medicare-qa-tool/medicare-payroll-taxes/ "medicare and payroll taxes") for most people, but Part B costs $174.70 a month in 2024. [High earners pay more](https://www.aarp.org/health/medicare-insurance/info-2022/how-to-lower-medicare-premiums.html "income and medicare premiums").

You may have to pay additional monthly premiums to the Medicare Advantage plan, which average $18.50 in 2024, but two-thirds of Medicare Advantage enrollees pay no separate premium.

**What Medicare Advantage covers.** The federal government requires Medicare Advantage plans to cover everything that Medicare Part A and Part B cover, but they may have different deductibles and copayments. Most Medicare Advantage plans include prescription drugs, too, and many help pay for [services original Medicare doesn’t cover](https://www.aarp.org/health/medicare-insurance/info-2018/services-not-covered.html "services not covered by medicare"), such as routine dental, hearing and vision care.
...
**Out-of-pocket maximums.** All Medicare Advantage plans have federal rules that limit annual out-of-pocket costs for services covered under Medicare Part A and Part B. In 2024, this is $8,850 or less for in-network health services, and $13,300 or less for covered in-network and out-of-network services combined.

ARTICLE CONTINUES AFTER ADVERTISEMENT

### How and when should I shop for a Medicare Advantage plan?

You can compare premiums, copayments and coverage for Medicare Advantage plans in your area, including copays for your drugs, by using the [Medicare Plan Finder](https://www.aarp.org/health/medicare-insurance/info-2022/advantage-enrollment.html "medicare advantage enrollment"). You usually need to contact the plan to find out if your doctors and hospitals are covered. You can then sign up through the Plan Finder or directly with the plan.

You can get a Medicare Advantage plan when you first enroll in Medicare or [in other situations](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/ "can you change part c plans"), such as within two months of losing employer coverage. Otherwise, you’ll have to wait until [open enrollment](https://www.aarp.org/health/medicare-insurance/info-2022/open-enrollment.html "medicare open enrollment") from Oct. 15 to Dec. 7 for coverage starting Jan. 1. Preexisting conditions don’t affect eligibility for Medicare Advantage.
...
If you choose original Medicare, you can use any doctor and facility that accepts Medicare. But you’ll have to buy separate Medigap and [Part D drug coverage](https://www.aarp.org/health/medicare-qa-tool/choosing-best-drug-plan-for-me/ "choosing the best medicare part d plan") to fill in the gaps.
...
With Medicare Advantage, you typically need to use a provider network. So if you go to an out-of-network doctor, your Medicare Advantage plan may not cover the visit or you’ll pay a higher copayment. You may also have more [prior authorization requirements](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-prior-authorization/ "what is medicare prior authorization") with a Medicare Advantage plan. Most Medicare Advantage plans include prescription drug coverage and may cover extra expenses.

#### Keep in mind

If you enroll in a Medicare Advantage plan, you cannot use a Medigap policy to cover your out-of-pocket expenses. So you’ll have to pay any deductible, copays or coinsurance yourself. And take note: It’s illegal for an insurance company to sell you a Medigap policy if you’re enrolled in a Medicare Advantage plan.

[Return to Medicare Q&A main page](https://www.aarp.org/health/medicare-qa-tool/ "Medicare Q&A Tool")

_(Scroll right to see the full chart below)_

[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage/#comments_widget_id)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 281: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 282](https://www.aarp.org/health/medicare-qa-tool/medigap-vs-advantage/)
