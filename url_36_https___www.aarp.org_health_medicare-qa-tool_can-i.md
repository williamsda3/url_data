Title: Can I change Medicare Advantage plans at any time?

URL Source: https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/

Published Time: 2022-04-20T04:00:00+0000
...
[Skip to content](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/#)

[](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/#)[](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/#)
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/insatisfecho-descontento-medicare-advantage/)

Published April 20, 2022

/ Updated January 09, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy.html&related=CreateTheGood&text=Can%20I%20change%20Medicare%20Advantage%20plans%20at%20any%20time?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy.html&title=Can%20I%20change%20Medicare%20Advantage%20plans%20at%20any%20time?)

No, you can’t switch [Medicare Advantage plans](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-advantage/ "what is medicare advantage") whenever you want but you have options if you’re unhappy with your plan.

You can shift to another plan or drop your Medicare Advantage plan altogether and move to [original Medicare](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/ "what is original medicare"). Technically, you can do this only during certain times of the year, but you may be eligible to change plans at other times too. Keep the two enrollment periods below in mind if you want to see doctors or use [medications that aren’t covered](https://www.aarp.org/health/medicare-qa-tool/medicare-formulary-rights-protections/ "medicare formulary rights and protections") under your Medicare Advantage plan.

**Annual enrollment period — Oct. 15 to Dec. 7.** You have many options to change coverage during [annual open enrollment](https://www.aarp.org/health/medicare-insurance/info-2022/open-enrollment.html "open enrollment"). You can switch to a different Medicare Advantage plan, change from an MA plan to original Medicare and vice versa, or switch from one Part D drug plan to another. Your coverage begins Jan. 1.
...
If you leave Medicare Advantage for original Medicare, you may not be guaranteed a [Medigap plan](https://www.aarp.org/health/medicare-insurance/info-2023/guide-to-medigap-plans.html "guide to medigap") except [under certain circumstances](https://www.aarp.org/health/medicare-qa-tool/best-time-to-buy-a-medigap-policy/ "when to buy medigap").

Members only

                     

### When can I change Medicare Advantage plans after open enrollment?
...
**If a five-star Medicare Advantage plan is available in your area.** The Centers for Medicare & Medicaid Services rank Medicare Advantage plans based on several quality measures, with five stars as the top rating. If a Medicare Advantage plan that covers your area earned an overall [five-star rating,](https://www.aarp.org/health/medicare-qa-tool/what-are-star-ratings/ "medicare star ratings") you can join that plan any time of year except the first week in December, and only once a year. Coverage begins the first day of the month after the plan receives your enrollment request.

To find out whether a five-star plan is available in your area, visit the [Medicare Plan Finder](https://www.medicare.gov/plan-compare "medicare plan finder") and filter results for your ZIP code based on the star ratings. Or call 800-MEDICARE (800-633-4227) or your [State Health Insurance Assistance Program](https://www.shiphelp.org/ "state health insurance program") to find out if five-star plans are available.
...
**During a special enrollment period.** Other situations allowing you to switch to another MA plan or change from MA to original Medicare include:
...
For more information, see Medicare.gov’s guide to [understanding special enrollment periods](https://www.medicare.gov/Pubs/pdf/11219-understanding-medicare-part-c-d.pdf "understanding medicare special enrollment periods"). Before choosing a new plan, it’s a good idea to [compare the Medicare Advantage options](https://www.aarp.org/health/medicare-qa-tool/finding-the-best-plan-for-me/ "choosing best medicare advantage plan") in your area. Learn [how to use the Medicare Plan Finder](https://www.aarp.org/health/medicare-insurance/info-2022/advantage-enrollment.html "medicare advantage enrollment") step by step to shop for Medicare Advantage plans.

ARTICLE CONTINUES AFTER ADVERTISEMENT

### Can I switch from Medicare Advantage to Medigap?

Even though you can leave a Medicare Advantage plan and switch to original Medicare during open enrollment and other times, you may not have a [guaranteed right to buy a Medigap policy](https://www.aarp.org/health/health-insurance/info-2021/avoid-medigap-mistakes.html "avoid these medigap mistakes") to cover original Medicare’s out-of-pocket costs if more than six months have passed since you signed up for Medicare Part B. Except in some cases, such as if you leave a Medicare Advantage plan during your 12-month trial period or you move out of your plan’s service area, Medigap insurers in most states can reject you or charge more if you have [preexisting conditions](https://www.aarp.org/health/medicare-qa-tool/medicare-preexisting-medical-conditions/ "medicare and preexisting conditions").

Before switching out of Medicare Advantage and into original Medicare, look at Medicare’s qualifications to see if you have a [guaranteed issue right](https://www.medicare.gov/supplements-other-insurance/when-can-i-buy-medigap/guaranteed-issue-rights "medicare guaranteed issue rights") to get Medigap coverage.

#### Keep in mind  

You can sign up for a Medicare Advantage plan when you’re [first eligible for Medicare,](https://www.aarp.org/health/medicare-insurance/info-2020/enrolling-in-medicare.html "enrolling in medicare") which is the seven-month initial enrollment period that starts three months before the month you turn 65 and ends three months afterward. If you delay enrolling in Medicare because you or your spouse are still working and have employer health coverage, you can enroll in a Medicare Advantage plan within two months of losing that coverage.

**Remember:** You must [sign up for Medicare Parts A and B](https://www.aarp.org/health/medicare-insurance/info-2022/initial-enrollment-period.html "initial enrollment period") before you can enroll in a Medicare Advantage plan. You’ll usually have to pay the premiums you owe for original Medicare in addition to any premium that a Medicare Advantage plan might charge.

[Return to Medicare Q&A main page](https://www.aarp.org/health/medicare-qa-tool/ "Medicare Q&A Tool")

[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/#comments_widget_id)
...
[New enrollees increasingly opting for the private insurance alternative to the federally-run program](https://www.aarp.org/health/medicare-insurance/info-2023/will-original-medicare-survive-medicare-advantage.html)
     ...
     [![Image 279: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 280: felt heart and stethoscope](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/medicare-advantage-and-chronic-conditions3.coreimg.50.932.jpeg/content/dam/aarp/health/medicare-and-medicaid/2023/10/1140-medicare-chronic-conditions.jpg)](https://www.aarp.org/health/medicare-insurance/info-2021/medicare-advantage-and-chronic-conditions.html "Get the Medicare Coverage You Need for a Chronic Condition
")
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 281: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 282](https://www.aarp.org/health/medicare-qa-tool/can-i-change-part-c-plans-if-unhappy/)
