Title: Do you need Medicare if you have Veterans’ health care?

URL Source: https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/

Published Time: 2023-02-23T05:00:00+0000

Markdown Content:
Do You Need Medicare if You Have Veterans’ Health Care?
===============
                                                     

[Skip to content](https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/#aarp-u-end-of-header)
...
[](https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/#)[](https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/#)
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/medicare-cobertura-veteranos/)

Published February 23, 2023

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage.html&related=CreateTheGood&text=)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage.html&title=)

You aren’t required to sign up for Medicare if you have health care coverage through the U.S. Department of Veterans Affairs (VA), but the VA encourages veterans to sign up for Medicare [Part A and Part B](https://www.aarp.org/health/medicare-insurance/info-01-2011/understanding_medicare_the_plans.html "understanding medicare's plans") during your [initial enrollment period](https://www.aarp.org/health/medicare-insurance/info-2022/initial-enrollment-period.html "medicare initial enrollment period") at 65, unless you also have [group insurance from a current employer.](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/ "medicare if still working")
...
VA health benefits typically won’t cover hospitals, doctors and other providers that participate in Medicare, nor will they cover Medicare [deductibles, copayments and coinsurance](https://www.aarp.org/health/medicare-qa-tool/does-medicare-cover-all-health-care-costs/ "does medicare cover all health care costs"). The rules are different for coordinating Medicare and [Tricare for Life coverage](https://www.aarp.org/health/medicare-qa-tool/military-tricare-medicare-spouse/ "medicare when you have veteran's coverage") for military retirees.
...
**Coverage varies.** When you [apply for VA health care,](https://www.aarp.org/home-family/voices/veterans/info-2020/enroll-va-health-care.html "how to enroll in VA healthcare") you’re assigned to a [priority group](https://www.va.gov/health-care/eligibility/priority-groups/ "VA priority groups") that determines your coverage and out-of-pocket costs within the VA system. The ratings are designed to ensure that veterans who need immediate care are assigned quickly.

The groups range from a priority of 1 — for [Medal of Honor recipients](https://www.aarp.org/home-family/voices/veterans/info-2022/national-medal-of-honor-museum.html "medal of honor museum") and veterans with service-connected illnesses or injuries rated to be at least 50 percent disabling — down to 8 — for veterans whose gross income exceeds VA limits and don’t have a service-connected disability qualifying them for VA compensation.
...
For more information about the different kinds of health benefits available for veterans, active-duty service members and military retirees and their families, see [AARP’s Veterans Health Benefits Navigator](https://www.aarp.org/home-family/voices/veterans/info-2022/health-benefits-navigator-digital-edition.html "veterans' benefits navigator").
...
If you don’t sign up for Medicare during your initial enrollment period at age 65, you may have to wait until the next [general enrollment period](https://www.aarp.org/health/medicare-qa-tool/when-first-eligible-didnt-enroll-can-i-join-later/ "joining medicare later if you missed your initial enrollment period") that runs Jan. 1 to March 31 each year, and you may have to pay a [late enrollment penalty](https://www.aarp.org/health/medicare-qa-tool/how-much-is-the-part-b-late-enrollment-penalty/ "medicare late enrollment penalty"). An exception: if you or your spouse is still working and you have health insurance from a current employer. In this case, you can choose to delay and not face a late enrollment penalty.

### **If I have VA drug coverage, do I need Medicare Part D?**

You aren’t required to buy Medicare [Part D prescription drug coverage](https://www.aarp.org/health/medicare-insurance/info-2018/part-d-prescription-drugs.html "medicare part d for prescription drugs") if you have VA health benefits. VA prescription drug benefits are considered as good as or better than Medicare Part D, which the Centers for Medicare & Medicaid Services calls “creditable coverage.” You won’t have to pay a penalty if you decide to sign up for Part D later.
...
If you have VA drug benefits, you can sign up for a Part D plan without paying a [late enrollment penalty](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/ "medicare late enrollment penalty") any time after you enroll in Medicare Part A or Part B or within 63 days of losing VA drug benefits.

#### **Keep in mind**

Medicare has premiums, deductibles, copayments and other [out-of-pocket costs](https://www.aarp.org/health/medicare-insurance/info-2018/out-of-pocket-prescription-costs.html "out of pocket prescription costs"). If your income and assets fall below certain levels, you may qualify for help with some of these expenses from a [Medicare Savings Program](https://www.aarp.org/health/medicare-insurance/info-2022/medicare-savings-program.html "medicare savings programs"). You also may be eligible for help with Medicare Part D premiums and copayments from the [Extra Help financial assistance program](https://www.aarp.org/health/medicare-qa-tool/financial-help-for-medication-costs/ "medicare extra help for prescription costs").

_Updated February 23, 2023  
_

[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/#comments_widget_id)
...
More on health
     ...
     [![Image 275: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 276: a social security card with money around it and a blue arrow pointing up](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/social-security-cola-increase1.coreimg.50.932.jpeg/content/dam/aarp/home-and-family/voices/veterans/2022/10/1140-veteran-cola-increase.jpg)](https://www.aarp.org/home-family/voices/veterans/info-2022/social-security-cola-increase.html "Veterans to See Biggest Payment Increase in Decades
")

[Veterans to See Biggest Payment Increase in Decades](https://www.aarp.org/home-family/voices/veterans/info-2022/social-security-cola-increase.html)

[Retired military and disabled veterans can expect an 8.7 percent jump in monthly payments](https://www.aarp.org/home-family/voices/veterans/info-2022/social-security-cola-increase.html)

     [![Image 277: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 278: man getting an eye exam](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/services-not-covered2.coreimg.50.932.jpeg/content/dam/aarp/health/medicare-and-medicaid/2020/06/1140-medicare-eye-exams.jpg)](https://www.aarp.org/health/medicare-insurance/info-2018/services-not-covered.html "10 Things Medicare Doesn’t Cover
")
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 281: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 282](https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/)
