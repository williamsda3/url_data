Title: What Counts as Income For SSI?

URL Source: https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/
...
[Skip to content](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/#)

[](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/#)[](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/#)
...
[Back](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/# "link to close menu")
...
[](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/# "Cancel")

[Continue](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/#) [Cancel](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/#)
...
Andy Markowitz and Tim Wendel,

AARP

Comments

[En español](https://www.aarp.org/espanol/jubilacion/seguro-social/preguntas-respuestas/que-cuenta-como-ingresos-para-ssi/)

Published August 18, 2021

/ Updated December 31, 2024

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi.html&related=CreateTheGood&text=What%20counts%20as%20income%20for%20SSI?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi.html&title=What%20counts%20as%20income%20for%20SSI?)

Income is a key factor in [determining eligibility](https://www.aarp.org/retirement/social-security/questions-answers/ssi-eligible/ "SSI eligibility") for [Supplemental Security Income](https://www.aarp.org/retirement/social-security/questions-answers/what-is-ssi/ "what is SSI") (SSI), a monthly benefit for people in financial straits who are 65 and older, blind or have a disability. The Social Security Administration (SSA), which operates the program, strictly regulates the type and amount of income someone can receive and still qualify for SSI.

There are also income limits that affect eligibility for [Social Security Disability Insurance](https://www.aarp.org/retirement/social-security/questions-answers/apply-for-ss-disability/ "apply for SSDI") (SSDI), the other disability benefit administered by the SSA. But for SSDI, only [earnings from work](https://www.aarp.org/retirement/social-security/questions-answers/what-is-substantial-gainful-activity/ "substantial gainful activity") count.

Members only

                     

For SSI, Social Security defines income much more broadly. It can include not just earnings from work but also money received from other sources, such as other government benefits or “in-kind support” from friends or family members to help cover your housing costs. (In-kind support formerly included help paying for food as well, but under an SSA rule that took effect Sept. 30. 2024, food aid no longer counts as income for SSI purposes.)

In 2025, the maximum federal SSI benefit is $967 a month for an individual and $1,450 a month for a married couple if both spouses are eligible. (The federal amounts are adjusted annually for inflation; most states [add supplementary payments](https://www.aarp.org/retirement/social-security/questions-answers/do-ssi-benefits-change-if-i-move-to-another-state/ "supplemental security income in different states") for some beneficiaries.) What the SSA calls “countable income” is deducted from those payments, and if your countable income exceeds the benefit cap, you cannot get SSI.
...
This includes government benefits, such as [Social Security payments](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/ "SSDI and SSI"), [unemployment insurance](https://www.aarp.org/retirement/social-security/questions-answers/collect-unemployment-benefits-and-social-security/ "unemployment and Social Security") and [veterans benefits](https://www.aarp.org/retirement/social-security/questions-answers/can-i-collect-both-ssdi-and-va-disability-compensation/ "SSDI and VA benefits"), as well as [pensions](https://www.aarp.org/retirement/social-security/questions-answers/pensions-and-social-security/ "pensions and Social Security"), interest income, dividends, income from a rental property, [workers’ compensation](https://www.aarp.org/retirement/social-security/questions-answers/workers-compensation/ "workers compensation") and cash from family and friends. It can also include alimony or child support.
...
Income from these sources — other than the first $20 a month in most cases — is deducted from your SSI benefit. If you have income only from such nonwork sources, you can receive up to $987 a month iun 2025 and still qualify for SSI.
...
*   [Supplemental Nutrition Assistance Program](https://www.aarp.org/politics-society/advocacy/info-2021/snap-benefits-increase.html "SNAP benefits") (SNAP) benefits, formerly known as food stamps  
    
*   [Home energy assistance](https://www.aarp.org/money/budgeting-saving/info-2022/ways-to-lower-utility-bills.html "energy assistance")
*   Disaster assistance
...
This is shelter you receive for free or for less than its fair market value. Think of in-kind income as funds that you would otherwise need to earn to pay for housing costs but that are instead being provided by a friend or family member.

For example, if someone other than a spouse you live with helps cover your rent or mortgage or pays your utility bills, that could count as [in-kind support](https://www.aarp.org/retirement/social-security/questions-answers/how-living-arrangements-affect-ssi/ "living arrangements and SSI") and result in a deduction from your SSI benefit.

Loans for this type of support that you must back do not count as in-kind income. Shelter provided by a nonprofit organization based on your need is also exempt.

### Deemed income

This category comes into play if an SSI beneficiary lives with a spouse or parent, or is an [immigrant](https://www.aarp.org/retirement/social-security/questions-answers/ssi-for-non-citizen/ "SSI for non-citizens") who receives support from a sponsor as a condition of U.S. residency. In these situations, the SSA may conclude that some of the family member's or sponsor's income is being put toward your care and deduct it from your SSI benefit.

There are other, highly specific examples of what does and doesn't count as income for SSI purposes. You'll find a [detailed list](https://www.ssa.gov/ssi/text-income-ussi.htm "income counted for Social Security") on Social Security's SSI website.

#### Keep in mind

*   Income is not the only financial factor in determining SSI eligibility. You also must have [limited resources](https://www.aarp.org/retirement/social-security/questions-answers/how-do-financial-resources-impact-ssi-eligibility/ "how social security counts financial resources for ess ess eye"), meaning cash, savings, stocks, bonds and other assets totaling no more than $2,000 for an individual or $3,000 for a couple.
*   Unlike with SSDI, you don't need to have [worked for a certain amount of time](https://www.aarp.org/retirement/social-security/questions-answers/how-long-do-i-have-to-work-to-qualify-for-ssdi/ "work requirements for SSDI") or [paid Social Security taxes](https://www.aarp.org/retirement/social-security/questions-answers/ss-fica/ "Social Security taxes") to qualify for SSI. The program, though administered by the SSA, is paid for by general U.S. Treasury funds, not Social Security taxes.

[%{postComment}%](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/#comments_widget_id)

_Andy Markowitz is an AARP senior writer and editor covering Social Security and retirement. He is a former editor of the_ Prague Post _and_ Baltimore City Paper_.  
  
Tim Wendel is a writer in residence at Johns Hopkins University in Baltimore and the author of several baseball-themed books, including_ High Heat_,_ Castro's Curveball _and_ Summer of '68_._
...
[How do I apply for Supplemental Security Income (SSI)?](https://www.aarp.org/retirement/social-security/questions-answers/how-do-i-apply-for-supplemental-security-income/)

[Can I have a savings account while on SSI or SSDI?](https://www.aarp.org/retirement/social-security/questions-answers/savings-account-impact-on-ssi-or-ssdi/)

[Can you get both SSDI and SSI?](https://www.aarp.org/retirement/social-security/questions-answers/can-you-get-both-ssdi-and-ssi/)
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 269: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 270](https://www.aarp.org/retirement/social-security/questions-answers/what-counts-as-income-for-ssi/)
