...
URL Source: https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/

Published Time: 2023-01-11T05:00:00+0000
...
[Skip to content](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/#aarp-u-end-of-header)
...
[](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/#)[](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/#)
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/multa-no-me-inscribi-parte-d/)

Published January 11, 2023

/ Updated November 20, 2023

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible.html&related=CreateTheGood&text=What%20is%20the%20Medicare%20Part%20D%20late%20enrollment%20penalty?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible.html&title=What%20is%20the%20Medicare%20Part%20D%20late%20enrollment%20penalty?)

The late enrollment penalty is a surcharge permanently added to the monthly premium of your [Part D prescription drug plan](https://www.aarp.org/health/medicare-insurance/info-2018/part-d-prescription-drugs.html "medicare part d for prescription drugs") if you fail to sign up when you’re [first eligible for Medicare](https://www.aarp.org/health/medicare-insurance/info-2020/enrolling-in-medicare.html "enrolling in medicare") and don’t have similar drug coverage.

Medicare calculates the penalty based on the number of months you delayed Part D enrollment and were without comparable drug coverage. This penalty applies after you enroll in either a stand-alone Part D plan to accompany [original Medicare](https://www.aarp.org/health/medicare-qa-tool/what-is-original-medicare/ "what is original medicare") or a [Medicare Advantage](https://www.aarp.org/health/medicare-qa-tool/what-is-medicare-advantage/ "what is medicare advantage") plan with drug coverage, unless you qualify for an exception.

Members only

                     

The Part D penalty has been in effect since Medicare introduced the drug benefit in 2006. At that time, people already in Medicare could sign up until May 15, 2006, without incurring a late enrollment penalty. Since then, Medicare has enforced the penalty policy for anyone who goes beyond 63 consecutive days without similar drug coverage after their [Part D initial enrollment period](https://www.aarp.org/health/medicare-qa-tool/when-can-i-enroll-in-a-part-d-plan/ "enrolling in medicare part d").
...
**If you** [**receive Extra Help**](https://www.aarp.org/health/medicare-qa-tool/financial-help-for-medication-costs/ "medicare extra help for prescription costs")**,** a federal program that helps people with low incomes and assets pay Part D premiums and out-of-pocket costs.

**If you’ve been** [**living outside the United States**](https://www.aarp.org/health/medicare-qa-tool/medicare-if-living-outside-united-states/ "medicare if living outside the US") or have been in prison — situations in which you can’t receive Part D drug coverage — you can avoid late penalties if you sign up with a Part D plan within two months of your return or release.

**If you** [**delayed enrolling in Medicare Part A and Part B**](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/ "medicare if you still work at 65") **at age 65,** you weren’t eligible to buy Part D yet so you can’t be penalized for late enrollment until you sign up for either part. But you must get Part D within two months of enrolling in Parts A or B to avoid penalties, unless you have other creditable coverage.

For example, some people who work for a company with 20 or more employees may want to delay enrolling in Parts A and B while working, so they can contribute to a [health savings account.](https://www.aarp.org/health/medicare-qa-tool/health-savings-account/ "medicare with health savings account") You can’t make new HSA contributions after you enroll in Medicare.
...
Medicare calculates a Part D penalty on the number of months you went without eligible coverage. You pay 1 percent of that year’s national base beneficiary premium multiplied by the number of months you were without creditable drug coverage since enrolling in Part A or Part B.

The Part D penalty has no cap. The base beneficiary premium, calculated by the Centers for Medicare & Medicaid Services each year, is different from the national average Part D premium.

**For example:** The national base beneficiary premium is $34.70 a month in 2024. If you went 29 months without creditable coverage, your penalty would be $10.10.

**The calculation:** 29 x 0.3470 = $10.063; the penalty is always rounded up to the nearest 10 cents.

Medicare adds this amount to your regular Part D premium each month. The penalty lasts for as long as you have Part D coverage; the amount is recalculated with each year’s national base beneficiary premium.
...
Ask your Part D plan provider for the paperwork, or download the [official form from CMS](https://www.cms.gov/files/document/part-d-lep-reconsideration-request-form-c2c.pdf "CMS late enrollment penalty appeal"), complete it and provide proof of creditable coverage during that time.

#### Keep in mind

While you may want to avoid paying Part D premiums, especially [if you don’t take medications or take very few](https://www.aarp.org/health/medicare-qa-tool/i-take-few-meds-do-i-need-a-part-d-plan/), you could still be liable for the late enrollment penalty if you don’t have equivalent drug coverage. To avoid a penalty, sign up for a low-premium Part D plan and [switch during open enrollment](https://www.aarp.org/health/medicare-insurance/info-2022/open-enrollment.html "medicare open enrollment") if medications prescribed later are too expensive or not covered under a more economical plan.

[Return to Medicare Q&A main page](https://www.aarp.org/health/medicare-qa-tool/ "Medicare Q&A Tool")

[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/#comments_widget_id)
...
More on Medicare
     ...
     [![Image 275: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 276: coins sitting on top of a Medicare card](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/what-are-costs-for-part-d1.coreimg.50.932.jpeg/content/dam/aarp/health/medicare_insurance/2020/06/1140-medicare-costs.jpg)](https://www.aarp.org/health/medicare-qa-tool/what-are-costs-for-part-d/ "What Costs Will I Have to Pay in a Medicare Part D Plan?")

[What Costs Will I Have to Pay in a Medicare Part D Plan?](https://www.aarp.org/health/medicare-qa-tool/what-are-costs-for-part-d/)

[Out-of-pocket costs go beyond your premium payments](https://www.aarp.org/health/medicare-qa-tool/what-are-costs-for-part-d/)

     [![Image 277: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 278: Medicare Card](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/choosing-best-drug-plan-for-me2.coreimg.50.932.jpeg/content/dam/aarp/health/medicare_insurance/2019/06/1140-medicare-card.jpg)](https://www.aarp.org/health/medicare-qa-tool/choosing-best-drug-plan-for-me/ "How Can I Pick the Best Prescription Plan For My Needs?
")

[How Can I Pick the Best Prescription Plan For My Needs?](https://www.aarp.org/health/medicare-qa-tool/choosing-best-drug-plan-for-me/)

[It needs to cover all your medicines at the lowest cost](https://www.aarp.org/health/medicare-qa-tool/choosing-best-drug-plan-for-me/)

     [![Image 279: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 280: A man sitting in front of a laptop looking at the redesigned Medicare Plan Finder website](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/understanding_medicare_the_plans3.coreimg.50.932.jpeg/content/dam/aarp/health/medicare_insurance/2019/08/1140-medicare-plan-finder-website.jpg)](https://www.aarp.org/health/medicare-insurance/info-01-2011/understanding_medicare_the_plans.html "Understanding Medicare’s Options: Parts A, B, C and D")
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 281: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 282](https://www.aarp.org/health/medicare-qa-tool/part-d-sign-up-penalty-after-first-eligible/)
