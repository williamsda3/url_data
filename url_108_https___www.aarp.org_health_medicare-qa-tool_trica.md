Title: How does Medicare work with Tricare and retiree plans?

URL Source: https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage/

Published Time: 2023-03-13T04:00:00+0000

Markdown Content:
How Does Medicare Work With Tricare and Retiree Plans?
===============
                                                     

[Skip to content](https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage/#aarp-u-end-of-header)

[Find upcoming events near you with AARP Local.](https://www.aarp.org/local?intcmp=ADS-ALRT-LOCAL "aarp local")

[](https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage/#)

[](https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage/#)[](https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage/#)
...
[Back](https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage/#)

[Health](https://www.aarp.org/health/ "link to health page")

[Close Menu](https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage/# "link to close menu")
...
[](https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage/# "Cancel")

[Continue](https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage/#) [Cancel](https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage/#)

[AARP Medicare Question and Answer Tool](https://www.aarp.org/health/medicare-qa-tool/)

What happens if I have retiree health coverage, Tricare and Medicare?
=====================================================================
...
[En español](https://www.aarp.org/espanol/salud/medicare-preguntas-respuestas/como-funciona-tricare-medicare-beneficios-empleador-juntos/)

Published March 13, 2023

*   [Facebook](http://www.facebook.com/sharer/sharer.php?u=https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage.html)
*   [Twitter](http://twitter.com/intent/tweet?url=https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage.html&related=CreateTheGood&text=What%20happens%20if%20I%20have%20retiree%20health%20coverage,%20Tricare%20and%20Medicare?)
*   [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage.html&title=What%20happens%20if%20I%20have%20retiree%20health%20coverage,%20Tricare%20and%20Medicare?)

If you’re enrolled in Medicare and have coverage from [Tricare for Life](https://www.aarp.org/health/medicare-qa-tool/military-tricare-medicare-spouse/ "medicare and tricare") and [retiree health insurance](https://www.aarp.org/health/medicare-qa-tool/former-employer-medicare-part-b/ "medicare and retiree health insurance") from a civilian job, Medicare pays first, the retiree health insurance pays second, and Tricare for Life pays third.
...
Think of it like this: Medicare almost always pays first when people are retired, enrolled in Medicare and entitled to one or more other types of health benefits. Usually, retiree benefits from a former employer or union or other forms of supplemental coverage such as [Medigap insurance](https://www.aarp.org/health/medicare-qa-tool/what-is-medigap-insurance/ "what is medigap insurance") pay second. Other government programs, such as [Medicaid](https://www.aarp.org/health/medicare-qa-tool/medicaid-medicare-eligibility/ "medicare and medicaid") or Tricare for Life, pay last.

The rules are different if you or [your spouse is still working](https://www.aarp.org/health/medicare-qa-tool/do-i-enroll-in-medicare-age-65-even-if-still-working/ "enrolling in medicare if you're still working") and you have coverage from an active employer. If the employer has 20 or more employees, the group health insurance pays first and Medicare pays second. For smaller employers, Medicare generally provides primary coverage at 65 and the employer’s coverage is secondary.
...
**But if you don’t sign up for Medicare at 65,** the scenario changes. Your retiree coverage may not pay your claims. The rules are different for [retired federal employees](https://www.aarp.org/health/medicare-qa-tool/retiring-federal-employee-fehb/ "medicare and federal retiree insurance") covered through the Federal Employees Health Benefits program.
...
**The coordination of benefits rules are different** if you qualify for Medicare before age 65 [because of a disability](https://www.aarp.org/retirement/social-security/info-2022/medicare-for-ssdi-beneficiaries.html "medicare for disability beneficiaries"). See [Medicare & Other Health Benefits: Your Guide to Who Pays First](https://www.medicare.gov/sites/default/files/2021-10/02179-Medicare-and-other-health-benefits-your-guide-to-who-pays-first.pdf "medicare guide to who pays first") for details.
...
**You can track your claims** with the [Medicare Summary Notice](https://www.aarp.org/health/medicare-qa-tool/medicare-summary-notice/ "what is a medicare summary notice"), a quarterly statement that lists amounts providers charge, how much Medicare paid and whether Medicare sent a claim for the remaining expenses to your other insurers. You can always access claims information through your [online Medicare account](https://www.aarp.org/health/medicare-qa-tool/medicare-online-account/ "online medicare account").

#### **Keep in mind**

The rules differ if you have [U.S. Department of Veterans Affairs (VA) and Medicare](https://www.aarp.org/health/medicare-qa-tool/does-medicare-work-with-veterans-coverage/ "medicare if you have veteran's health coverage") coverage. The two entities don’t coordinate benefits.
...
For more information about health benefits for veterans, see [AARP’s Veterans Health Benefits Navigator](https://www.aarp.org/home-family/voices/veterans/info-2022/health-benefits-navigator-digital-edition.html "AARP veteran's health navigator").

_Updated March 13, 2023_

[Return to Medicare Q&A main page](https://www.aarp.org/health/medicare-qa-tool/ "Medicare Q&A Tool")

[%{postComment}%](https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage/#comments_widget_id)
...
More on health
     ...
     [![Image 275: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 276: Medicare card, glasses, and pen on a desk](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/tricare-retiree-medicare-coverage/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/finding-answers-to-medicare-questions1.coreimg.50.932.jpeg/content/dam/aarp/health/medicare_insurance/2023/03/1140-medicare-card-pen.jpg)](https://www.aarp.org/health/medicare-qa-tool/finding-answers-to-medicare-questions/ "Where can I find answers to my Medicare questions?
")
...
[We have 5 resources for you to check out, including AARP](https://www.aarp.org/health/medicare-qa-tool/finding-answers-to-medicare-questions/)
     ...
     [![Image 277: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 278: Medicare Card](https://cdn.aarp.net/content/dam/aarpe/en/home/health/medicare-qa-tool/tricare-retiree-medicare-coverage/_jcr_content/root/container_main/container_moreAarp_main/container_moreAarp/container_moreAarp_cmp/featuredlist/tabItem/turning-65-when-to-apply-for-medicare2.coreimg.50.932.jpeg/content/dam/aarp/health/medicare_insurance/2019/06/1140-medicare-card.jpg)](https://www.aarp.org/health/medicare-qa-tool/turning-65-when-to-apply-for-medicare/ "I turn 65 soon. When should I sign up for Medicare?")
...
[See All](https://www.aarp.org/membership/benefits/all-offers-a-z/ "See All")
 ...
 ![Image 281: spinner image](https://cdn.aarp.net/etc/uxdia/images/uxdia-spinner.svg) ![Image 282](https://www.aarp.org/health/medicare-qa-tool/tricare-retiree-medicare-coverage/)
